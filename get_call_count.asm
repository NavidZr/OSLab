...
int main(int argc, char *argv[]){
  ...
  2a:	6a 01                	push   $0x1
  2c:	e8 ef 04 00 00       	call   520 <printf>
  ...
  62:	6a 01                	push   $0x1
  64:	e8 b7 04 00 00       	call   520 <printf>
      	  	printf(1, "\n-----------------------------------------------------------\n");
  69:	58                   	pop    %eax
  6a:	5a                   	pop    %edx
  6b:	68 68 09 00 00       	push   $0x968
  70:	6a 01                	push   $0x1
  72:	e8 a9 04 00 00       	call   520 <printf>
			exit();
  ...
  b3:	50                   	push   %eax
  b4:	68 d0 09 00 00       	push   $0x9d0
  b9:	6a 01                	push   $0x1
  bb:	e8 60 04 00 00       	call   520 <printf>
		    printf(1,"User: the number of times the system call SYS_fork was called in second child process: %d\n" , get_call_count(SYS_fork));
  c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c7:	e8 7f 03 00 00       	call   44b <get_call_count>
  cc:	83 c4 0c             	add    $0xc,%esp
  cf:	50                   	push   %eax
  d0:	68 2c 0a 00 00       	push   $0xa2c
 ...
 115:	6a 01                	push   $0x1
 117:	e8 04 04 00 00       	call   520 <printf>
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 60 0b 00 00 	movzbl 0xb60(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb 59 0b 00 00       	mov    $0xb59,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 08 0e 00 00       	mov    0xe08,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 08 0e 00 00       	mov    %eax,0xe08
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 08 0e 00 00       	mov    %eax,0xe08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d 08 0e 00 00    	mov    0xe08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d 08 0e 00 00    	mov    0xe08,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 08 0e 00 00       	mov    0xe08,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 08 0e 00 00       	mov    %eax,0xe08
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 08 0e 00 00 0c 	movl   $0xe0c,0xe08
 857:	0e 00 00 
    base.s.size = 0;
 85a:	bf 0c 0e 00 00       	mov    $0xe0c,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 0c 0e 00 00 0c 	movl   $0xe0c,0xe0c
 866:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 10 0e 00 00 00 	movl   $0x0,0xe10
 872:	00 00 00 
    if(p->s.size >= nunits){
