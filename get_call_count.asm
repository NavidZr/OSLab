...
int main(int argc, char *argv[]){
  ...
  f3:	50                   	push   %eax
  f4:	68 98 0a 00 00       	push   $0xa98
  f9:	6a 01                	push   $0x1
  fb:	e8 30 04 00 00       	call   530 <printf>
 ...
 115:	6a 01                	push   $0x1
 117:	e8 14 04 00 00       	call   530 <printf>
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 70 0b 00 00 	movzbl 0xb70(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6b4:	eb 1a                	jmp    6d0 <printf+0x1a0>
          s = "(null)";
 6b6:	bb 69 0b 00 00       	mov    $0xb69,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 705:	a1 18 0e 00 00       	mov    0xe18,%eax
{
 ...
 726:	73 10                	jae    738 <free+0x38>
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	a3 18 0e 00 00       	mov    %eax,0xe18
}
 757:	5e                   	pop    %esi
 758:	5f                   	pop    %edi
 759:	5d                   	pop    %ebp
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 18 0e 00 00       	mov    %eax,0xe18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 79d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7a0:	8b 3d 18 0e 00 00    	mov    0xe18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e9:	8b 3d 18 0e 00 00    	mov    0xe18,%edi
 ...
 812:	e8 e9 fe ff ff       	call   700 <free>
  return freep;
 817:	a1 18 0e 00 00       	mov    0xe18,%eax
 ...
 844:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 847:	a3 18 0e 00 00       	mov    %eax,0xe18
}
 ...
 85e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 18 0e 00 00 1c 	movl   $0xe1c,0xe18
 867:	0e 00 00 
    base.s.size = 0;
 86a:	bf 1c 0e 00 00       	mov    $0xe1c,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 1c 0e 00 00 1c 	movl   $0xe1c,0xe1c
 876:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 87b:	c7 05 20 0e 00 00 00 	movl   $0x0,0xe20
 882:	00 00 00 
    if(p->s.size >= nunits){
