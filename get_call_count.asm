...
int main(int argc, char *argv[]){
  ...
  54:	e8 f2 03 00 00       	call   44b <get_call_count>
  59:	83 c4 0c             	add    $0xc,%esp
  5c:	50                   	push   %eax
  5d:	68 fc 08 00 00       	push   $0x8fc
		child_b = fork();
		if (child_b == 0) {  
            sleep(100);
  ...
  62:	6a 01                	push   $0x1
  64:	e8 a7 04 00 00       	call   510 <printf>
      	  	printf(1, "\n-----------------------------------------------------------\n");
  69:	58                   	pop    %eax
  6a:	5a                   	pop    %edx
  6b:	68 58 09 00 00       	push   $0x958
  70:	6a 01                	push   $0x1
  72:	e8 99 04 00 00       	call   510 <printf>
			exit();
  77:	e8 27 03 00 00       	call   3a3 <exit>
		child_b = fork();
  7c:	e8 1a 03 00 00       	call   39b <fork>
		if (child_b == 0) {  
  81:	85 c0                	test   %eax,%eax
  83:	75 52                	jne    d7 <main+0xd7>
            sleep(100);
  85:	83 ec 0c             	sub    $0xc,%esp
  88:	6a 64                	push   $0x64
  8a:	e8 a4 03 00 00       	call   433 <sleep>
		    printf(1,"User: second child process with pid=%d\n", getpid());
  8f:	e8 8f 03 00 00       	call   423 <getpid>
  94:	83 c4 0c             	add    $0xc,%esp
  97:	50                   	push   %eax
  98:	68 98 09 00 00       	push   $0x998
  9d:	6a 01                	push   $0x1
  9f:	e8 6c 04 00 00       	call   510 <printf>
		    printf(1,"User: the number of times the system call SYS_write was called in second child process: %d\n" , get_call_count(SYS_write));
  a4:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  ab:	e8 9b 03 00 00       	call   44b <get_call_count>
  b0:	83 c4 0c             	add    $0xc,%esp
  b3:	50                   	push   %eax
  b4:	68 c0 09 00 00       	push   $0x9c0
  b9:	6a 01                	push   $0x1
  bb:	e8 50 04 00 00       	call   510 <printf>
		    printf(1,"User: the number of times the system call SYS_fork was called in second child process: %d\n" , get_call_count(SYS_fork));
  c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c7:	e8 7f 03 00 00       	call   44b <get_call_count>
  cc:	83 c4 0c             	add    $0xc,%esp
  cf:	50                   	push   %eax
  d0:	68 1c 0a 00 00       	push   $0xa1c
  d5:	eb 8b                	jmp    62 <main+0x62>
        }
  	  	else {
      	  	
      		wait();
  d7:	e8 cf 02 00 00       	call   3ab <wait>
       		wait();
  dc:	e8 ca 02 00 00       	call   3ab <wait>
            sleep(100);
  e1:	83 ec 0c             	sub    $0xc,%esp
  e4:	6a 64                	push   $0x64
  e6:	e8 48 03 00 00       	call   433 <sleep>
            printf(1,"User: parent process with pid=%d\n", getpid());
  eb:	e8 33 03 00 00       	call   423 <getpid>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	50                   	push   %eax
  f4:	68 78 0a 00 00       	push   $0xa78
  f9:	6a 01                	push   $0x1
  fb:	e8 10 04 00 00       	call   510 <printf>
            printf(1,"User: the number of times the system call SYS_write was called in parent process: %d\n" , get_call_count(SYS_write));
 100:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
 107:	e8 3f 03 00 00       	call   44b <get_call_count>
 10c:	83 c4 0c             	add    $0xc,%esp
 10f:	50                   	push   %eax
 110:	68 9c 0a 00 00       	push   $0xa9c
 115:	6a 01                	push   $0x1
 117:	e8 f4 03 00 00       	call   510 <printf>
 ...
 123:	e8 23 03 00 00       	call   44b <get_call_count>
 128:	83 c4 0c             	add    $0xc,%esp
 12b:	50                   	push   %eax
 12c:	68 f4 0a 00 00       	push   $0xaf4
 131:	e9 2c ff ff ff       	jmp    62 <main+0x62>
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 50 0b 00 00 	movzbl 0xb50(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb 49 0b 00 00       	mov    $0xb49,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e5:	a1 f8 0d 00 00       	mov    0xdf8,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 f8 0d 00 00       	mov    %eax,0xdf8
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 f8 0d 00 00       	mov    %eax,0xdf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d f8 0d 00 00    	mov    0xdf8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d f8 0d 00 00    	mov    0xdf8,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 f8 0d 00 00       	mov    0xdf8,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 f8 0d 00 00       	mov    %eax,0xdf8
}
 ...
 83e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 f8 0d 00 00 fc 	movl   $0xdfc,0xdf8
 847:	0d 00 00 
    base.s.size = 0;
 84a:	bf fc 0d 00 00       	mov    $0xdfc,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 fc 0d 00 00 fc 	movl   $0xdfc,0xdfc
 856:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 00 0e 00 00 00 	movl   $0x0,0xe00
 862:	00 00 00 
    if(p->s.size >= nunits){
