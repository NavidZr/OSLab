...
int main(int argc, char *argv[]){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    int child_a, child_b;
    child_a = fork();
  11:	e8 75 03 00 00       	call   38b <fork>
    if (child_a == 0) {     
  16:	85 c0                	test   %eax,%eax
  18:	75 5e                	jne    78 <main+0x78>
        printf(1,"User: first child process with pid=%d\n", getpid());
  1a:	e8 f4 03 00 00       	call   413 <getpid>
  1f:	51                   	push   %ecx
  20:	50                   	push   %eax
  21:	68 88 08 00 00       	push   $0x888
  26:	6a 01                	push   $0x1
  28:	e8 33 05 00 00       	call   560 <printf>
  ...
  34:	e8 02 04 00 00       	call   43b <get_call_count>
  39:	83 c4 0c             	add    $0xc,%esp
  3c:	50                   	push   %eax
  3d:	68 b0 08 00 00       	push   $0x8b0
  42:	6a 01                	push   $0x1
  ...
  50:	e8 e6 03 00 00       	call   43b <get_call_count>
  ...
  5e:	6a 01                	push   $0x1
  60:	e8 fb 04 00 00       	call   560 <printf>
      	  	printf(1, "\n-----------------------------------------------------------\n");
  65:	58                   	pop    %eax
  66:	5a                   	pop    %edx
  67:	68 68 09 00 00       	push   $0x968
  6c:	6a 01                	push   $0x1
  6e:	e8 ed 04 00 00       	call   560 <printf>
			exit();
  73:	e8 1b 03 00 00       	call   393 <exit>
		child_b = fork();
  78:	e8 0e 03 00 00       	call   38b <fork>
		if (child_b == 0) {  
  7d:	85 c0                	test   %eax,%eax
  7f:	75 52                	jne    d3 <main+0xd3>
            sleep(100);
  81:	83 ec 0c             	sub    $0xc,%esp
  84:	6a 64                	push   $0x64
  86:	e8 98 03 00 00       	call   423 <sleep>
		    printf(1,"User: second child process with pid=%d\n", getpid());
  8b:	e8 83 03 00 00       	call   413 <getpid>
  90:	83 c4 0c             	add    $0xc,%esp
  93:	50                   	push   %eax
  94:	68 a8 09 00 00       	push   $0x9a8
  99:	6a 01                	push   $0x1
  9b:	e8 c0 04 00 00       	call   560 <printf>
		    printf(1,"User: the number of times the system call SYS_write was called in second child process: %d\n" , get_call_count(SYS_write));
  a0:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  a7:	e8 8f 03 00 00       	call   43b <get_call_count>
  ac:	83 c4 0c             	add    $0xc,%esp
  af:	50                   	push   %eax
  b0:	68 d0 09 00 00       	push   $0x9d0
  b5:	6a 01                	push   $0x1
  b7:	e8 a4 04 00 00       	call   560 <printf>
		    printf(1,"User: the number of times the system call SYS_fork was called in second child process: %d\n" , get_call_count(SYS_fork));
  bc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c3:	e8 73 03 00 00       	call   43b <get_call_count>
  c8:	83 c4 0c             	add    $0xc,%esp
  cb:	50                   	push   %eax
  cc:	68 2c 0a 00 00       	push   $0xa2c
  d1:	eb 8b                	jmp    5e <main+0x5e>
        }
  	  	else {
      	  	
      		wait();
  d3:	e8 c3 02 00 00       	call   39b <wait>
       		wait();
  d8:	e8 be 02 00 00       	call   39b <wait>
            sleep(100);
  dd:	83 ec 0c             	sub    $0xc,%esp
  e0:	6a 64                	push   $0x64
  e2:	e8 3c 03 00 00       	call   423 <sleep>
            printf(1,"User: parent process with pid=%d\n", getpid());
  e7:	e8 27 03 00 00       	call   413 <getpid>
  ec:	83 c4 0c             	add    $0xc,%esp
  ef:	50                   	push   %eax
  f0:	68 88 0a 00 00       	push   $0xa88
  f5:	6a 01                	push   $0x1
  f7:	e8 64 04 00 00       	call   560 <printf>
            printf(1,"User: the number of times the system call SYS_write was called in parent process: %d\n" , get_call_count(SYS_write));
  fc:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
 103:	e8 33 03 00 00       	call   43b <get_call_count>
 108:	83 c4 0c             	add    $0xc,%esp
 10b:	50                   	push   %eax
 10c:	68 ac 0a 00 00       	push   $0xaac
 111:	6a 01                	push   $0x1
 113:	e8 48 04 00 00       	call   560 <printf>
 ...
 11f:	e8 17 03 00 00       	call   43b <get_call_count>
 124:	83 c4 0c             	add    $0xc,%esp
 127:	50                   	push   %eax
 128:	68 04 0b 00 00       	push   $0xb04
 12d:	e9 2c ff ff ff       	jmp    5e <main+0x5e>
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 b8 0b 00 00 	movzbl 0xbb8(%edx),%edx
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a5:	57                   	push   %edi
 5a6:	56                   	push   %esi
 5a7:	e8 07 fe ff ff       	call   3b3 <write>
 ...
 5d9:	ff 24 85 60 0b 00 00 	jmp    *0xb60(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5fe:	e8 b0 fd ff ff       	call   3b3 <write>
        putc(fd, c);
 ...
 60f:	57                   	push   %edi
 610:	56                   	push   %esi
 611:	e8 9d fd ff ff       	call   3b3 <write>
        putc(fd, c);
 ...
 67b:	57                   	push   %edi
 67c:	56                   	push   %esi
 67d:	e8 31 fd ff ff       	call   3b3 <write>
        while(*s != 0){
 ...
 6bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6bf:	e8 ef fc ff ff       	call   3b3 <write>
        ap++;
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba 59 0b 00 00       	mov    $0xb59,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 7f3:	e8 23 fc ff ff       	call   41b <sbrk>
  if(p == (char*)-1)
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 857:	0e 00 00 
    base.s.size = 0;
 85a:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 866:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 872:	00 00 00 
    if(p->s.size >= nunits){
