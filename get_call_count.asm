...
int main(int argc, char *argv[]){
  ...
  1f:	51                   	push   %ecx
  20:	50                   	push   %eax
  21:	68 38 08 00 00       	push   $0x838
  26:	6a 01                	push   $0x1
  28:	e8 e3 04 00 00       	call   510 <printf>
  ...
  42:	6a 01                	push   $0x1
  44:	e8 c7 04 00 00       	call   510 <printf>
  ...
  f5:	6a 01                	push   $0x1
  f7:	e8 14 04 00 00       	call   510 <printf>
 ...
 111:	6a 01                	push   $0x1
 113:	e8 f8 03 00 00       	call   510 <printf>
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 68 0b 00 00 	movzbl 0xb68(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 10 0b 00 00 	jmp    *0xb10(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 09 0b 00 00       	mov    $0xb09,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 10 0e 00 00       	mov    0xe10,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 10 0e 00 00    	mov    %edx,0xe10
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 10 0e 00 00    	mov    %edx,0xe10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 10 0e 00 00    	mov    0xe10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 10 0e 00 00    	mov    0xe10,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 10 0e 00 00    	mov    0xe10,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 10 0e 00 00    	mov    %edx,0xe10
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 10 0e 00 00 14 	movl   $0xe14,0xe10
 807:	0e 00 00 
    base.s.size = 0;
 80a:	bf 14 0e 00 00       	mov    $0xe14,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 14 0e 00 00 14 	movl   $0xe14,0xe14
 816:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 18 0e 00 00 00 	movl   $0x0,0xe18
 822:	00 00 00 
    if(p->s.size >= nunits){
