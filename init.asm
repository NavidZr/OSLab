 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 e8 08 00 00 	movzbl 0x8e8(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 07 fe ff ff       	call   363 <write>
 ...
 589:	ff 24 85 90 08 00 00 	jmp    *0x890(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5ae:	e8 b0 fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 9d fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 62b:	57                   	push   %edi
 62c:	56                   	push   %esi
 62d:	e8 31 fd ff ff       	call   363 <write>
        while(*s != 0){
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 66f:	e8 ef fc ff ff       	call   363 <write>
        ap++;
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 88 08 00 00       	mov    $0x888,%edx
        while(*s != 0){
 ...
 6b1:	a1 9c 0b 00 00       	mov    0xb9c,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 9c 0b 00 00    	mov    0xb9c,%edx
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf a0 0b 00 00       	mov    $0xba0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 822:	00 00 00 
    if(p->s.size >= nunits){
