...
0000069b <release_rl>:
 69b:	b8 23 00 00 00       	mov    $0x23,%eax
 6a0:	cd 40                	int    $0x40
 6a2:	c3                   	ret    
 ...
 6bc:	89 d1                	mov    %edx,%ecx
{
 ...
 6e9:	0f b6 92 34 0b 00 00 	movzbl 0xb34(%edx),%edx
 ...
 72e:	56                   	push   %esi
 72f:	57                   	push   %edi
 730:	e8 7e fe ff ff       	call   5b3 <write>
  while(--i >= 0)
 ...
 769:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7a5:	57                   	push   %edi
 7a6:	56                   	push   %esi
 7a7:	e8 07 fe ff ff       	call   5b3 <write>
 ...
 7d9:	ff 24 85 dc 0a 00 00 	jmp    *0xadc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7fe:	e8 b0 fd ff ff       	call   5b3 <write>
        putc(fd, c);
 ...
 80f:	57                   	push   %edi
 810:	56                   	push   %esi
 811:	e8 9d fd ff ff       	call   5b3 <write>
        putc(fd, c);
 ...
 87b:	57                   	push   %edi
 87c:	56                   	push   %esi
 87d:	e8 31 fd ff ff       	call   5b3 <write>
        while(*s != 0){
 ...
 8bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8bf:	e8 ef fc ff ff       	call   5b3 <write>
        ap++;
 ...
 8e7:	90                   	nop
          s = "(null)";
 8e8:	ba d2 0a 00 00       	mov    $0xad2,%edx
        while(*s != 0){
 ...
 901:	a1 74 0e 00 00       	mov    0xe74,%eax
{
 ...
 941:	5b                   	pop    %ebx
  freep = p;
 942:	89 15 74 0e 00 00    	mov    %edx,0xe74
}
 948:	5e                   	pop    %esi
 949:	5f                   	pop    %edi
 94a:	5d                   	pop    %ebp
 ...
 979:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 97c:	89 15 74 0e 00 00    	mov    %edx,0xe74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 999:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 99c:	8b 3d 74 0e 00 00    	mov    0xe74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9df:	73 4f                	jae    a30 <malloc+0xa0>
    ...
    if(p == freep)
 9e1:	8b 3d 74 0e 00 00    	mov    0xe74,%edi
 ...
 9f3:	e8 23 fc ff ff       	call   61b <sbrk>
  if(p == (char*)-1)
 ...
 a0a:	e8 f1 fe ff ff       	call   900 <free>
  return freep;
 a0f:	8b 15 74 0e 00 00    	mov    0xe74,%edx
 ...
 a57:	0e 00 00 
    base.s.size = 0;
 a5a:	bf 78 0e 00 00       	mov    $0xe78,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 a69:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a6b:	c7 05 7c 0e 00 00 00 	movl   $0x0,0xe7c
 a72:	00 00 00 
    if(p->s.size >= nunits){
