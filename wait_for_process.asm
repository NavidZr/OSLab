...
int main(int argc, char *argv[]){
  ...
  1a:	75 39                	jne    55 <main+0x55>
        int cnt=0;
        printf(1,"User: child process 1 with pid=%d is working!\n", getpid());
  1c:	e8 82 03 00 00       	call   3a3 <getpid>
  21:	52                   	push   %edx
  22:	50                   	push   %eax
  ...
  2a:	e8 71 04 00 00       	call   4a0 <printf>
        while(cnt!=100000)
            cnt++;
        sleep(1000);
  2f:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
  36:	e8 78 03 00 00       	call   3b3 <sleep>
        printf(1,"User: child process 1 with pid=%d is done!\n", getpid());
  3b:	e8 63 03 00 00       	call   3a3 <getpid>
  ...
  4b:	e8 50 04 00 00       	call   4a0 <printf>
		exit();
  50:	e8 ce 02 00 00       	call   323 <exit>
  55:	89 c3                	mov    %eax,%ebx
    }
	else{
		child_b = fork();
  57:	e8 bf 02 00 00       	call   31b <fork>
		if (child_b == 0) {  
  5c:	85 c0                	test   %eax,%eax
  5e:	75 2c                	jne    8c <main+0x8c>
            sleep(10);
  60:	83 ec 0c             	sub    $0xc,%esp
  63:	6a 0a                	push   $0xa
  65:	e8 49 03 00 00       	call   3b3 <sleep>
            printf(1,"User: child process 2 with pid=%d is waiting!\n", getpid());
  6a:	e8 34 03 00 00       	call   3a3 <getpid>
  6f:	83 c4 0c             	add    $0xc,%esp
  72:	50                   	push   %eax
  73:	68 64 08 00 00       	push   $0x864
  78:	6a 01                	push   $0x1
  7a:	e8 21 04 00 00       	call   4a0 <printf>
            wait_for_process(child_a_pid);
  7f:	89 1c 24             	mov    %ebx,(%esp)
  82:	e8 54 03 00 00       	call   3db <wait_for_process>
	        /*if(wait_for_process(child_a_pid) == -1)
                printf(1,"User: Waiting failed!");
            else
                printf(1,"User: waiting done correctly!");*/
			exit();
  87:	e8 97 02 00 00       	call   323 <exit>
        }
  	  	else {
      	  	
      		wait();
  8c:	e8 9a 02 00 00       	call   32b <wait>
       		wait();
  91:	e8 95 02 00 00       	call   32b <wait>
            sleep(100);
  96:	83 ec 0c             	sub    $0xc,%esp
  99:	6a 64                	push   $0x64
  9b:	e8 13 03 00 00       	call   3b3 <sleep>
            printf(1,"User: parent process with pid=%d is exiting\n", getpid());
  a0:	e8 fe 02 00 00       	call   3a3 <getpid>
  a5:	83 c4 0c             	add    $0xc,%esp
  a8:	50                   	push   %eax
  a9:	68 94 08 00 00       	push   $0x894
  ae:	6a 01                	push   $0x1
...
000003c3 <find_next_prime_number>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb c1 08 00 00       	mov    $0x8c1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 74 0b 00 00       	mov    0xb74,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 74 0b 00 00       	mov    %eax,0xb74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 74 0b 00 00       	mov    0xb74,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 74 0b 00 00 78 	movl   $0xb78,0xb74
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 78 0b 00 00       	mov    $0xb78,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 78 0b 00 00 78 	movl   $0xb78,0xb78
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 7c 0b 00 00 00 	movl   $0x0,0xb7c
 7f2:	00 00 00 
    if(p->s.size >= nunits){
