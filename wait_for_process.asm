...
int main(int argc, char *argv[]){
   ...
   e:	51                   	push   %ecx
    int child_a, child_b;
    child_a = fork();
   f:	e8 e7 02 00 00       	call   2fb <fork>
  ...
  18:	e8 66 03 00 00       	call   383 <getpid>
  1d:	51                   	push   %ecx
  1e:	50                   	push   %eax
  1f:	68 a8 07 00 00       	push   $0x7a8
  24:	6a 01                	push   $0x1
  26:	e8 55 04 00 00       	call   480 <printf>
        while(cnt!=10000000)
            cnt++;
        printf(1,"User: child process 1 with pid=%d is done!\n", getpid());
  2b:	e8 53 03 00 00       	call   383 <getpid>
  ...
  4e:	75 25                	jne    75 <main+0x75>
            sleep(3);
  50:	83 ec 0c             	sub    $0xc,%esp
  53:	6a 03                	push   $0x3
  55:	e8 39 03 00 00       	call   393 <sleep>
            wait_for_process(child_a_pid);
  5a:	89 1c 24             	mov    %ebx,(%esp)
  5d:	e8 59 03 00 00       	call   3bb <wait_for_process>
  ...
  6b:	e8 10 04 00 00       	call   480 <printf>
			exit();
  70:	e8 8e 02 00 00       	call   303 <exit>
        }
  	  	else {
  ...
  75:	e8 91 02 00 00       	call   30b <wait>
       		wait();
  7a:	e8 8c 02 00 00       	call   30b <wait>
            sleep(100);
  7f:	83 ec 0c             	sub    $0xc,%esp
  82:	6a 64                	push   $0x64
  84:	e8 0a 03 00 00       	call   393 <sleep>
  ...
  99:	e8 e2 03 00 00       	call   480 <printf>
 	...
 	exit();
  9e:	e8 60 02 00 00       	call   303 <exit>
  a3:	66 90                	xchg   %ax,%ax
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
...
000003a3 <find_next_prime_number>:
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 65 08 00 00       	mov    $0x865,%edx
        while(*s != 0){
