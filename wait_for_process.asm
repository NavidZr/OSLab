...
int main(int argc, char *argv[]){
  ...
  1d:	51                   	push   %ecx
  1e:	50                   	push   %eax
  1f:	68 f8 07 00 00       	push   $0x7f8
  24:	6a 01                	push   $0x1
  26:	e8 a5 04 00 00       	call   4d0 <printf>
        while(cnt!=10000000)
            cnt++;
  ...
  33:	50                   	push   %eax
  34:	68 28 08 00 00       	push   $0x828
  39:	6a 01                	push   $0x1
  3b:	e8 90 04 00 00       	call   4d0 <printf>
		exit();
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 14 09 00 00 	movzbl 0x914(%edx),%edx
 ...
 49e:	56                   	push   %esi
 49f:	57                   	push   %edi
 4a0:	e8 7e fe ff ff       	call   323 <write>
  while(--i >= 0)
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 515:	57                   	push   %edi
 516:	56                   	push   %esi
 517:	e8 07 fe ff ff       	call   323 <write>
 ...
 549:	ff 24 85 bc 08 00 00 	jmp    *0x8bc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 56e:	e8 b0 fd ff ff       	call   323 <write>
        putc(fd, c);
 ...
 57f:	57                   	push   %edi
 580:	56                   	push   %esi
 581:	e8 9d fd ff ff       	call   323 <write>
        putc(fd, c);
 ...
 62c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 62f:	e8 ef fc ff ff       	call   323 <write>
        ap++;
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba b5 08 00 00       	mov    $0x8b5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 c0 0b 00 00       	mov    0xbc0,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 c0 0b 00 00    	mov    %edx,0xbc0
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 c0 0b 00 00    	mov    %edx,0xbc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d c0 0b 00 00    	mov    0xbc0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d c0 0b 00 00    	mov    0xbc0,%edi
 ...
 763:	e8 23 fc ff ff       	call   38b <sbrk>
  if(p == (char*)-1)
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 c0 0b 00 00    	mov    0xbc0,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 c0 0b 00 00    	mov    %edx,0xbc0
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 c0 0b 00 00 c4 	movl   $0xbc4,0xbc0
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf c4 0b 00 00       	mov    $0xbc4,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 c4 0b 00 00 c4 	movl   $0xbc4,0xbc4
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 c8 0b 00 00 00 	movl   $0x0,0xbc8
 7e2:	00 00 00 
    if(p->s.size >= nunits){
