 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 cc 08 00 00 	movzbl 0x8cc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb c5 08 00 00       	mov    $0x8c5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 78 0b 00 00       	mov    0xb78,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 78 0b 00 00       	mov    %eax,0xb78
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 78 0b 00 00       	mov    %eax,0xb78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d 78 0b 00 00    	mov    0xb78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d 78 0b 00 00    	mov    0xb78,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 78 0b 00 00       	mov    0xb78,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 78 0b 00 00       	mov    %eax,0xb78
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 78 0b 00 00 7c 	movl   $0xb7c,0xb78
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 7c 0b 00 00       	mov    $0xb7c,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 7c 0b 00 00 7c 	movl   $0xb7c,0xb7c
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 80 0b 00 00 00 	movl   $0x0,0xb80
 7f2:	00 00 00 
    if(p->s.size >= nunits){
