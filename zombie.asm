...
0000038b <release_rl>:
 38b:	b8 23 00 00 00       	mov    $0x23,%eax
 390:	cd 40                	int    $0x40
 392:	c3                   	ret    
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 41e:	56                   	push   %esi
 41f:	57                   	push   %edi
 420:	e8 7e fe ff ff       	call   2a3 <write>
  while(--i >= 0)
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 495:	57                   	push   %edi
 496:	56                   	push   %esi
 497:	e8 07 fe ff ff       	call   2a3 <write>
 ...
 4ee:	e8 b0 fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 4ff:	57                   	push   %edi
 500:	56                   	push   %esi
 501:	e8 9d fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 5ac:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5af:	e8 ef fc ff ff       	call   2a3 <write>
        ap++;
...
free(void *ap)
{
 ...
 5f1:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 80 0a 00 00    	mov    %edx,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 762:	00 00 00 
    if(p->s.size >= nunits){
