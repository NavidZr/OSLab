...
int main(int argc, char *argv[]){
  ...
  1f:	50                   	push   %eax
  20:	68 b8 07 00 00       	push   $0x7b8
  25:	6a 01                	push   $0x1
  27:	e8 24 04 00 00       	call   450 <printf>
  ...
  41:	6a 01                	push   $0x1
  43:	e8 08 04 00 00       	call   450 <printf>
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb 4c 08 00 00       	mov    $0x84c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 fc 0a 00 00       	mov    0xafc,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
