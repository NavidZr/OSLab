...
int main(int argc, char *argv[]){
  ...
  11:	6a 01                	push   $0x1
  13:	e8 5b 03 00 00       	call   373 <get_most_caller>
  ...
  28:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  2f:	e8 3f 03 00 00       	call   373 <get_most_caller>
  ...
  44:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  4b:	e8 23 03 00 00       	call   373 <get_most_caller>
  50:	83 c4 0c             	add    $0xc,%esp
  53:	50                   	push   %eax
  54:	68 1c 08 00 00       	push   $0x81c
  59:	6a 01                	push   $0x1
...
free(void *ap)
{
 ...
 631:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 54 0b 00 00    	mov    %edx,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 58 0b 00 00       	mov    $0xb58,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 7a2:	00 00 00 
    if(p->s.size >= nunits){
