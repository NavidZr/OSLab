...
int main(int argc, char *argv[]){
  ...
  15:	6a 01                	push   $0x1
  17:	e8 67 03 00 00       	call   383 <get_most_caller>
  1c:	83 c4 0c             	add    $0xc,%esp
  1f:	50                   	push   %eax
  20:	68 c8 07 00 00       	push   $0x7c8
  25:	6a 01                	push   $0x1
  27:	e8 34 04 00 00       	call   460 <printf>
    printf(1,"The most caller process for SYS_write : pid=%d \n", get_most_caller(SYS_write));
  2c:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  33:	e8 4b 03 00 00       	call   383 <get_most_caller>
  ...
  4f:	e8 2f 03 00 00       	call   383 <get_most_caller>
  54:	83 c4 0c             	add    $0xc,%esp
  57:	50                   	push   %eax
  58:	68 2c 08 00 00       	push   $0x82c
  5d:	6a 01                	push   $0x1
  5f:	e8 fc 03 00 00       	call   460 <printf>
    exit();
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 5c 08 00 00       	mov    $0x85c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 0c 0b 00 00       	mov    0xb0c,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
