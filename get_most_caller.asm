 ...
 5e1:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 04 0b 00 00    	mov    %edx,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 08 0b 00 00       	mov    $0xb08,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 752:	00 00 00 
    if(p->s.size >= nunits){
