...
int main(int argc, char *argv[]){
  ...
  3b:	50                   	push   %eax
  3c:	68 d8 07 00 00       	push   $0x7d8
  41:	6a 01                	push   $0x1
  43:	e8 f8 03 00 00       	call   440 <printf>
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb 3c 08 00 00       	mov    $0x83c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 ec 0a 00 00       	mov    0xaec,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
