...
fork1(void)
{
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     106:	68 c1 13 00 00       	push   $0x13c1
     10b:	6a 02                	push   $0x2
  ...
  exit();
    ...
    panic("fork");
     ...
     122:	68 1b 13 00 00       	push   $0x131b
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 18 13 00 00       	push   $0x1318
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 b5 13 00 00       	push   $0x13b5
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 1b 13 00 00       	push   $0x131b
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 d0 13 00 00 	jmp    *0x13d0(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 27 13 00 00       	push   $0x1327
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2cf:	68 47 13 00 00       	push   $0x1347
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     347:	6a 54                	push   $0x54
     349:	e8 d2 0e 00 00       	call   1220 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     377:	6a 18                	push   $0x18
     379:	e8 a2 0e 00 00       	call   1220 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3c7:	6a 0c                	push   $0xc
     3c9:	e8 52 0e 00 00       	call   1220 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     407:	6a 0c                	push   $0xc
     409:	e8 12 0e 00 00       	call   1220 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     447:	6a 08                	push   $0x8
     449:	e8 d2 0d 00 00       	call   1220 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 3c 1a 00 00       	push   $0x1a3c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 3c 1a 00 00       	push   $0x1a3c
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 34 1a 00 00       	push   $0x1a34
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 3c 1a 00 00       	push   $0x1a3c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 3c 1a 00 00       	push   $0x1a3c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 69 13 00 00       	push   $0x1369
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 4c 13 00 00       	push   $0x134c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 6c 13 00 00       	push   $0x136c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 83 13 00 00       	push   $0x1383
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 75 13 00 00       	push   $0x1375
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 6e 13 00 00       	push   $0x136e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 88 13 00 00       	push   $0x1388
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 8a 13 00 00       	push   $0x138a
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 86 13 00 00       	push   $0x1386
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 6c 13 00 00       	push   $0x136c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 a8 13 00 00       	push   $0x13a8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 e8 13 00 00 	jmp    *0x13e8(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 36 13 00 00       	push   $0x1336
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 aa 13 00 00       	push   $0x13aa
     bb5:	6a 02                	push   $0x2
     bb7:	e8 34 04 00 00       	call   ff0 <printf>
    panic("syntax");
     bbc:	c7 04 24 6e 13 00 00 	movl   $0x136e,(%esp)
...
00000f2b <release_rl>:
     f2b:	b8 23 00 00 00       	mov    $0x23,%eax
     f30:	cd 40                	int    $0x40
     f32:	c3                   	ret    
     ...
     f4c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f79:	0f b6 92 60 14 00 00 	movzbl 0x1460(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     fbe:	56                   	push   %esi
     fbf:	57                   	push   %edi
     fc0:	e8 7e fe ff ff       	call   e43 <write>
  while(--i >= 0)
     ...
     ff9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1035:	57                   	push   %edi
    1036:	56                   	push   %esi
    1037:	e8 07 fe ff ff       	call   e43 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1069:	ff 24 85 08 14 00 00 	jmp    *0x1408(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    108e:	e8 b0 fd ff ff       	call   e43 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    109f:	57                   	push   %edi
    10a0:	56                   	push   %esi
    10a1:	e8 9d fd ff ff       	call   e43 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    110b:	57                   	push   %edi
    110c:	56                   	push   %esi
    110d:	e8 31 fd ff ff       	call   e43 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    114f:	e8 ef fc ff ff       	call   e43 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1177:	90                   	nop
          s = "(null)";
    1178:	ba 00 14 00 00       	mov    $0x1400,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1191:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11ac:	39 ca                	cmp    %ecx,%edx
    11ae:	73 30                	jae    11e0 <free+0x50>
    11b0:	39 c1                	cmp    %eax,%ecx
    11b2:	72 04                	jb     11b8 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11b4:	39 c2                	cmp    %eax,%edx
    11b6:	72 f0                	jb     11a8 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    11b8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    11bb:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    11be:	39 f8                	cmp    %edi,%eax
    11c0:	74 30                	je     11f2 <free+0x62>
    ...
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    11c5:	8b 42 04             	mov    0x4(%edx),%eax
    11c8:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    11cb:	39 f1                	cmp    %esi,%ecx
    11cd:	74 3a                	je     1209 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    11cf:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    11d1:	5b                   	pop    %ebx
  freep = p;
    11d2:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
    11d8:	5e                   	pop    %esi
    11d9:	5f                   	pop    %edi
    11da:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e0:	39 c2                	cmp    %eax,%edx
    11e2:	72 c4                	jb     11a8 <free+0x18>
    11e4:	39 c1                	cmp    %eax,%ecx
    11e6:	73 c0                	jae    11a8 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    11e8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    11eb:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    11ee:	39 f8                	cmp    %edi,%eax
    11f0:	75 d0                	jne    11c2 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    11f2:	03 70 04             	add    0x4(%eax),%esi
    11f5:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    11f8:	8b 02                	mov    (%edx),%eax
    11fa:	8b 00                	mov    (%eax),%eax
    11fc:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    11ff:	8b 42 04             	mov    0x4(%edx),%eax
    1202:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    1205:	39 f1                	cmp    %esi,%ecx
    1207:	75 c6                	jne    11cf <free+0x3f>
    p->s.size += bp->s.size;
    1209:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    120c:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
    p->s.size += bp->s.size;
    1212:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    1215:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1218:	89 0a                	mov    %ecx,(%edx)
}
    121a:	5b                   	pop    %ebx
    121b:	5e                   	pop    %esi
    121c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    122c:	8b 3d c4 1a 00 00    	mov    0x1ac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1232:	8d 70 07             	lea    0x7(%eax),%esi
    1235:	c1 ee 03             	shr    $0x3,%esi
    1238:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    123b:	85 ff                	test   %edi,%edi
    123d:	0f 84 9d 00 00 00    	je     12e0 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1243:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    1245:	8b 4a 04             	mov    0x4(%edx),%ecx
    1248:	39 f1                	cmp    %esi,%ecx
    124a:	73 6a                	jae    12b6 <malloc+0x96>
    124c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1251:	39 de                	cmp    %ebx,%esi
    1253:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    1256:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    125d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1260:	eb 17                	jmp    1279 <malloc+0x59>
    1262:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1268:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    126a:	8b 48 04             	mov    0x4(%eax),%ecx
    126d:	39 f1                	cmp    %esi,%ecx
    126f:	73 4f                	jae    12c0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1271:	8b 3d c4 1a 00 00    	mov    0x1ac4,%edi
    1277:	89 c2                	mov    %eax,%edx
    1279:	39 d7                	cmp    %edx,%edi
    127b:	75 eb                	jne    1268 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    127d:	83 ec 0c             	sub    $0xc,%esp
    1280:	ff 75 e4             	push   -0x1c(%ebp)
    1283:	e8 23 fc ff ff       	call   eab <sbrk>
  if(p == (char*)-1)
    1288:	83 c4 10             	add    $0x10,%esp
    128b:	83 f8 ff             	cmp    $0xffffffff,%eax
    128e:	74 1c                	je     12ac <malloc+0x8c>
  hp->s.size = nu;
    1290:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1293:	83 ec 0c             	sub    $0xc,%esp
    1296:	83 c0 08             	add    $0x8,%eax
    1299:	50                   	push   %eax
    129a:	e8 f1 fe ff ff       	call   1190 <free>
  return freep;
    129f:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
      if((p = morecore(nunits)) == 0)
    12a5:	83 c4 10             	add    $0x10,%esp
    12a8:	85 d2                	test   %edx,%edx
    12aa:	75 bc                	jne    1268 <malloc+0x48>
        return 0;
  }
}
    ...
    12b8:	89 fa                	mov    %edi,%edx
    12ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    12c0:	39 ce                	cmp    %ecx,%esi
    12c2:	74 4c                	je     1310 <malloc+0xf0>
        p->s.size -= nunits;
    12c4:	29 f1                	sub    %esi,%ecx
    12c6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    12c9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    12cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    12cf:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
    ...
    12df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    12e0:	c7 05 c4 1a 00 00 c8 	movl   $0x1ac8,0x1ac4
    12e7:	1a 00 00 
    base.s.size = 0;
    12ea:	bf c8 1a 00 00       	mov    $0x1ac8,%edi
    base.s.ptr = freep = prevp = &base;
    12ef:	c7 05 c8 1a 00 00 c8 	movl   $0x1ac8,0x1ac8
    12f6:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    12fb:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
    1302:	00 00 00 
    if(p->s.size >= nunits){
    1305:	e9 42 ff ff ff       	jmp    124c <malloc+0x2c>
    130a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1310:	8b 08                	mov    (%eax),%ecx
    1312:	89 0a                	mov    %ecx,(%edx)
    1314:	eb b9                	jmp    12cf <malloc+0xaf>
