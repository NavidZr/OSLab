...
000006cb <release_rl>:
 6cb:	b8 23 00 00 00       	mov    $0x23,%eax
 6d0:	cd 40                	int    $0x40
 6d2:	c3                   	ret    
 ...
 6ec:	89 d1                	mov    %edx,%ecx
{
 ...
 719:	0f b6 92 50 0b 00 00 	movzbl 0xb50(%edx),%edx
 ...
 75e:	56                   	push   %esi
 75f:	57                   	push   %edi
 760:	e8 7e fe ff ff       	call   5e3 <write>
  while(--i >= 0)
 ...
 799:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7d5:	57                   	push   %edi
 7d6:	56                   	push   %esi
 7d7:	e8 07 fe ff ff       	call   5e3 <write>
 ...
 809:	ff 24 85 f8 0a 00 00 	jmp    *0xaf8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 82e:	e8 b0 fd ff ff       	call   5e3 <write>
        putc(fd, c);
 ...
 83f:	57                   	push   %edi
 840:	56                   	push   %esi
 841:	e8 9d fd ff ff       	call   5e3 <write>
        putc(fd, c);
 ...
 8ab:	57                   	push   %edi
 8ac:	56                   	push   %esi
 8ad:	e8 31 fd ff ff       	call   5e3 <write>
        while(*s != 0){
 ...
 8ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8ef:	e8 ef fc ff ff       	call   5e3 <write>
        ap++;
 ...
 917:	90                   	nop
          s = "(null)";
 918:	ba ee 0a 00 00       	mov    $0xaee,%edx
        while(*s != 0){
 ...
 931:	a1 00 13 00 00       	mov    0x1300,%eax
{
 ...
 971:	5b                   	pop    %ebx
  freep = p;
 972:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 978:	5e                   	pop    %esi
 979:	5f                   	pop    %edi
 97a:	5d                   	pop    %ebp
 ...
 9a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ac:	89 15 00 13 00 00    	mov    %edx,0x1300
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9cc:	8b 3d 00 13 00 00    	mov    0x1300,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a0f:	73 4f                	jae    a60 <malloc+0xa0>
    ...
    if(p == freep)
 a11:	8b 3d 00 13 00 00    	mov    0x1300,%edi
 ...
 a23:	e8 23 fc ff ff       	call   64b <sbrk>
  if(p == (char*)-1)
 ...
 a3a:	e8 f1 fe ff ff       	call   930 <free>
  return freep;
 a3f:	8b 15 00 13 00 00    	mov    0x1300,%edx
 ...
 a6c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a6f:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 ...
 a7f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a80:	c7 05 00 13 00 00 04 	movl   $0x1304,0x1300
 a87:	13 00 00 
    base.s.size = 0;
 a8a:	bf 04 13 00 00       	mov    $0x1304,%edi
    base.s.ptr = freep = prevp = &base;
 a8f:	c7 05 04 13 00 00 04 	movl   $0x1304,0x1304
 a96:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a99:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a9b:	c7 05 08 13 00 00 00 	movl   $0x0,0x1308
 aa2:	00 00 00 
    if(p->s.size >= nunits){
