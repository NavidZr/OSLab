 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 00 0b 00 00       	mov    0xb00,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 00 0b 00 00       	mov    %eax,0xb00
}
