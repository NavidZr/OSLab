...
int main(int argc, char *argv[]){
  ...
  25:	e8 36 02 00 00       	call   260 <atoi>
  ...
  33:	50                   	push   %eax
  34:	68 cc 07 00 00       	push   $0x7cc
  39:	6a 01                	push   $0x1
  3b:	e8 00 04 00 00       	call   440 <printf>
		printf(1, "First prime number after %d is: %d\n" , number , find_next_prime_number());
  40:	e8 2e 03 00 00       	call   373 <find_next_prime_number>
  45:	50                   	push   %eax
  46:	53                   	push   %ebx
  47:	68 04 08 00 00       	push   $0x804
  4c:	6a 01                	push   $0x1
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb 28 08 00 00       	mov    $0x828,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 e0 0a 00 00       	mov    0xae0,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 ...
 76e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf e4 0a 00 00       	mov    $0xae4,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 792:	00 00 00 
    if(p->s.size >= nunits){
