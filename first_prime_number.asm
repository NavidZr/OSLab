 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb 38 08 00 00       	mov    $0x838,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
