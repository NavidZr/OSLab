...
_first_prime_number:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  21:	e8 2a 02 00 00       	call   250 <atoi>
  ...
  35:	6a 01                	push   $0x1
  37:	e8 04 04 00 00       	call   440 <printf>
		printf(1, "First prime number after %d is: %d\n" , number , find_next_prime_number());
  3c:	e8 22 03 00 00       	call   363 <find_next_prime_number>
  41:	50                   	push   %eax
  42:	53                   	push   %ebx
  43:	68 c4 07 00 00       	push   $0x7c4
  48:	6a 01                	push   $0x1
  4a:	e8 f1 03 00 00       	call   440 <printf>
		asm("movl %0, %%ebx" : : "r"(saved_ebx)); // ebx = saved_ebx -> restore
  4f:	89 f3                	mov    %esi,%ebx
		exit();  	
  51:	83 c4 20             	add    $0x20,%esp
  54:	e8 6a 02 00 00       	call   2c3 <exit>
		printf(2, "You must enter exactly 1 number!\n");
  59:	50                   	push   %eax
  5a:	50                   	push   %eax
  5b:	68 68 07 00 00       	push   $0x768
  60:	6a 02                	push   $0x2
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 48 08 00 00 	movzbl 0x848(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 f0 07 00 00 	jmp    *0x7f0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba e8 07 00 00       	mov    $0x7e8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf fc 0a 00 00       	mov    $0xafc,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 752:	00 00 00 
    if(p->s.size >= nunits){
