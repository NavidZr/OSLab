...
_set_bjf_params:     file format elf32-i386
...
{  
  ...
  36:	59                   	pop    %ecx
  37:	ff 73 04             	push   0x4(%ebx)
  3a:	89 c6                	mov    %eax,%esi
  3c:	e8 ff 01 00 00       	call   240 <atoi>
  41:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  44:	52                   	push   %edx
  45:	57                   	push   %edi
  46:	56                   	push   %esi
  47:	50                   	push   %eax
  48:	e8 3e 03 00 00       	call   38b <set_bjf_params>
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 44e:	56                   	push   %esi
 44f:	57                   	push   %edi
 450:	e8 7e fe ff ff       	call   2d3 <write>
  while(--i >= 0)
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c5:	57                   	push   %edi
 4c6:	56                   	push   %esi
 4c7:	e8 07 fe ff ff       	call   2d3 <write>
 ...
 51e:	e8 b0 fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 5dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5df:	e8 ef fc ff ff       	call   2d3 <write>
        ap++;
...
free(void *ap)
{
 ...
 621:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 bc 0a 00 00    	mov    %edx,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
 ...
 713:	e8 23 fc ff ff       	call   33b <sbrk>
  if(p == (char*)-1)
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf c0 0a 00 00       	mov    $0xac0,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 792:	00 00 00 
    if(p->s.size >= nunits){
