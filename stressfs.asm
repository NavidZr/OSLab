 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 4e9:	0f b6 92 0c 09 00 00 	movzbl 0x90c(%edx),%edx
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 b4 08 00 00 	jmp    *0x8b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba ab 08 00 00       	mov    $0x8ab,%edx
        while(*s != 0){
 ...
 701:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 872:	00 00 00 
    if(p->s.size >= nunits){
