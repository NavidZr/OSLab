...
_set_global_bjf_params:     file format elf32-i386
...
{  
  ...
  17:	ff 77 0c             	push   0xc(%edi)
  1a:	e8 11 02 00 00       	call   230 <atoi>
  1f:	89 c6                	mov    %eax,%esi
  21:	58                   	pop    %eax
  22:	ff 77 08             	push   0x8(%edi)
  25:	e8 06 02 00 00       	call   230 <atoi>
  2a:	5a                   	pop    %edx
  2b:	ff 77 04             	push   0x4(%edi)
  ...
  39:	53                   	push   %ebx
  3a:	50                   	push   %eax
  3b:	e8 33 03 00 00       	call   373 <set_global_bjf_params>
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 43e:	56                   	push   %esi
 43f:	57                   	push   %edi
 440:	e8 7e fe ff ff       	call   2c3 <write>
  while(--i >= 0)
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b5:	57                   	push   %edi
 4b6:	56                   	push   %esi
 4b7:	e8 07 fe ff ff       	call   2c3 <write>
 ...
 51f:	57                   	push   %edi
 520:	56                   	push   %esi
 521:	e8 9d fd ff ff       	call   2c3 <write>
        putc(fd, c);
 ...
 5cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5cf:	e8 ef fc ff ff       	call   2c3 <write>
        ap++;
...
free(void *ap)
{
 ...
 611:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 ac 0a 00 00    	mov    %edx,0xaac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
 ...
 703:	e8 23 fc ff ff       	call   32b <sbrk>
  if(p == (char*)-1)
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 ac 0a 00 00    	mov    %edx,0xaac
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf b0 0a 00 00       	mov    $0xab0,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
