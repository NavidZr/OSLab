...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 8e 7a 10 80 	movl   $0x80107a8e,(%esp)
...
80100da1:	e8 ca 3c 00 00       	call   80104a70 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 fb 37 00 00       	call   80104620 <initlock>
}
...
80100e41:	e8 aa 39 00 00       	call   801047f0 <acquire>
...
80100e71:	e8 1a 39 00 00       	call   80104790 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 01 39 00 00       	call   80104790 <release>
}
...
80100eaf:	e8 3c 39 00 00       	call   801047f0 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 bf 38 00 00       	call   80104790 <release>
  return f;
}
...
80100f01:	e8 ea 38 00 00       	call   801047f0 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 4f 38 00 00       	call   80104790 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 1d 38 00 00       	jmp    80104790 <release>
...
80101325:	e8 86 35 00 00       	call   801048b0 <memset>
  log_write(bp);
...
8010136a:	e8 81 34 00 00       	call   801047f0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 b4 33 00 00       	call   80104790 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 86 33 00 00       	call   80104790 <release>
      return ip;
...
80101541:	e8 0a 34 00 00       	call   80104950 <memmove>
  brelse(bp);
...
80101576:	e8 a5 30 00 00       	call   80104620 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 5c 2f 00 00       	call   801044f0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 8f 33 00 00       	call   80104950 <memmove>
  brelse(bp);
...
8010168e:	e8 1d 32 00 00       	call   801048b0 <memset>
      dip->type = type;
...
80101731:	e8 1a 32 00 00       	call   80104950 <memmove>
  log_write(bp);
...
8010175f:	e8 8c 30 00 00       	call   801047f0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 1c 30 00 00       	call   80104790 <release>
}
...
801017a2:	e8 89 2d 00 00       	call   80104530 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 33 31 00 00       	call   80104950 <memmove>
    brelse(bp);
...
80101873:	e8 58 2d 00 00       	call   801045d0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 fc 2c 00 00       	jmp    80104590 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 6b 2c 00 00       	call   80104530 <acquiresleep>
...
801018da:	e8 b1 2c 00 00       	call   80104590 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 05 2f 00 00       	call   801047f0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 8b 2e 00 00       	jmp    80104790 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 db 2e 00 00       	call   801047f0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 6c 2e 00 00       	call   80104790 <release>
    if(r == 1){
...
80101a23:	e8 a8 2b 00 00       	call   801045d0 <holdingsleep>
...
80101a3a:	e8 51 2b 00 00       	call   80104590 <releasesleep>
  iput(ip);
...
80101b37:	e8 14 2e 00 00       	call   80104950 <memmove>
    brelse(bp);
...
80101c33:	e8 18 2d 00 00       	call   80104950 <memmove>
    log_write(bp);
...
80101cce:	e8 ed 2c 00 00       	call   801049c0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 8e 2c 00 00       	call   801049c0 <strncmp>
      continue;
...
80101dba:	e8 31 2a 00 00       	call   801047f0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 c1 29 00 00       	call   80104790 <release>
...
80101e8c:	e8 3f 27 00 00       	call   801045d0 <holdingsleep>
...
80101eae:	e8 dd 26 00 00       	call   80104590 <releasesleep>
  iput(ip);
...
80101edb:	e8 70 2a 00 00       	call   80104950 <memmove>
    name[len] = 0;
...
80101f2b:	e8 a0 26 00 00       	call   801045d0 <holdingsleep>
...
80101f4a:	e8 41 26 00 00       	call   80104590 <releasesleep>
  iput(ip);
...
80101f6d:	e8 5e 26 00 00       	call   801045d0 <holdingsleep>
...
80101f90:	e8 3b 26 00 00       	call   801045d0 <holdingsleep>
...
80101fa7:	e8 e4 25 00 00       	call   80104590 <releasesleep>
}
...
8010203d:	e8 ce 29 00 00       	call   80104a10 <strncpy>
...
80102088:	68 0e 7c 10 80       	push   $0x80107c0e
...
801021d0:	e8 4b 24 00 00       	call   80104620 <initlock>
...
8010224e:	e8 9d 25 00 00       	call   801047f0 <acquire>
...
801022cb:	e8 c0 24 00 00       	call   80104790 <release>
...
801022ee:	e8 dd 22 00 00       	call   801045d0 <holdingsleep>
...
80102328:	e8 c3 24 00 00       	call   801047f0 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 05 24 00 00       	jmp    80104790 <release>
...
801024f2:	e8 b9 23 00 00       	call   801048b0 <memset>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 48 22 00 00       	jmp    80104790 <release>
    panic("kfree");
...
80102625:	e8 f6 1f 00 00       	call   80104620 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 38 21 00 00       	call   801047f0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 aa 20 00 00       	call   80104790 <release>
  return (char*)r;
...
80102af7:	e8 04 1e 00 00       	call   80104900 <memcmp>
...
80102c24:	e8 27 1d 00 00       	call   80104950 <memmove>
...
80102cd4:	e8 47 19 00 00       	call   80104620 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 80 1a 00 00       	call   801047f0 <acquire>
...
80102dbc:	e8 cf 19 00 00       	call   80104790 <release>
      break;
    }
  }
}
...
80102dde:	e8 0d 1a 00 00       	call   801047f0 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 6f 19 00 00       	call   80104790 <release>
}
...
80102e36:	e8 b5 19 00 00       	call   801047f0 <acquire>
    wakeup(&log);
...
80102e58:	e8 33 19 00 00       	call   80104790 <release>
...
80102eb4:	e8 97 1a 00 00       	call   80104950 <memmove>
...
80102f14:	e8 77 18 00 00       	call   80104790 <release>
...
80102f76:	e8 75 18 00 00       	call   801047f0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 d6 17 00 00       	jmp    80104790 <release>
...
801030d4:	e8 77 18 00 00       	call   80104950 <memmove>
...
801031c4:	e8 37 17 00 00       	call   80104900 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 7c 16 00 00       	call   80104900 <memcmp>
...
801033c8:	e8 33 15 00 00       	call   80104900 <memcmp>
...
801034a9:	e8 72 11 00 00       	call   80104620 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 ac 12 00 00       	call   801047f0 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 07 12 00 00       	jmp    80104790 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 f7 11 00 00       	call   80104790 <release>
    kfree((char*)p);
...
801035dd:	e8 0e 12 00 00       	call   801047f0 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 1f 11 00 00       	call   80104790 <release>
        return -1;
...
801036c2:	e8 c9 10 00 00       	call   80104790 <release>
  return n;
...
801036e6:	e8 05 11 00 00       	call   801047f0 <acquire>
...
8010377e:	e8 0d 10 00 00       	call   80104790 <release>
  return i;
...
80103799:	e8 f2 0f 00 00       	call   80104790 <release>
      return -1;
...
801037c1:	e8 2a 10 00 00       	call   801047f0 <acquire>
801037c6:	83 c4 10             	add    $0x10,%esp
801037c9:	eb 13                	jmp    801037de <allocproc+0x2e>
801037cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
...
801037ff:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103805:	e8 86 0f 00 00       	call   80104790 <release>
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 44 5b 10 80 	movl   $0x80105b44,0x14(%eax)
  p->context = (struct context*)sp;
...
80103839:	e8 72 10 00 00       	call   801048b0 <memset>
...
80103862:	e8 29 0f 00 00       	call   80104790 <release>
}
...
8010389b:	e8 f0 0e 00 00       	call   80104790 <release>
...
801038e6:	68 c0 79 10 80       	push   $0x801079c0
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 2b 0d 00 00       	call   80104620 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 14 0d 00 00       	call   801046a0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 54 0d 00 00       	call   801046f0 <popcli>
}
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 55 11 80       	mov    %eax,0x80115554
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 68 37 00 00       	call   80107130 <setupkvm>
801039c8:	89 43 04             	mov    %eax,0x4(%ebx)
801039cb:	85 c0                	test   %eax,%eax
801039cd:	0f 84 db 00 00 00    	je     80103aae <userinit+0xfe>
...
801039e1:	e8 fa 33 00 00       	call   80106de0 <inituvm>
...
801039f6:	e8 b5 0e 00 00       	call   801048b0 <memset>
...
80103a2f:	8d 93 e0 00 00 00    	lea    0xe0(%ebx),%edx
80103a35:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103a3c:	8b 43 18             	mov    0x18(%ebx),%eax
80103a3f:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103a46:	8b 43 18             	mov    0x18(%ebx),%eax
80103a49:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  for(int k=0; k < 25; k++)
80103a50:	8d 43 7c             	lea    0x7c(%ebx),%eax
80103a53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103a57:	90                   	nop
  	p->syscnt[k] = 0;
80103a58:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(int k=0; k < 25; k++)
80103a5e:	83 c0 04             	add    $0x4,%eax
80103a61:	39 c2                	cmp    %eax,%edx
80103a63:	75 f3                	jne    80103a58 <userinit+0xa8>
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a65:	83 ec 04             	sub    $0x4,%esp
80103a68:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103a6b:	6a 10                	push   $0x10
80103a6d:	68 f0 79 10 80       	push   $0x801079f0
80103a72:	50                   	push   %eax
80103a73:	e8 f8 0f 00 00       	call   80104a70 <safestrcpy>
  p->cwd = namei("/");
80103a78:	c7 04 24 f9 79 10 80 	movl   $0x801079f9,(%esp)
80103a7f:	e8 1c e6 ff ff       	call   801020a0 <namei>
80103a84:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a87:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103a8e:	e8 5d 0d 00 00       	call   801047f0 <acquire>
  p->state = RUNNABLE;
80103a93:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a9a:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103aa1:	e8 ea 0c 00 00       	call   80104790 <release>
}
...
80103ab1:	68 d7 79 10 80       	push   $0x801079d7
80103ab6:	e8 c5 c8 ff ff       	call   80100380 <panic>
...
80103ac5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ac8:	e8 d3 0b 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80103acd:	e8 2e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ad2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ad8:	e8 13 0c 00 00       	call   801046f0 <popcli>
  sz = curproc->sz;
...
80103aeb:	e8 e0 31 00 00       	call   80106cd0 <switchuvm>
  return 0;
...
80103b0a:	e8 41 34 00 00       	call   80106f50 <allocuvm>
...
80103b2a:	e8 51 35 00 00       	call   80107080 <deallocuvm>
...
80103b46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b49:	e8 52 0b 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80103b4e:	e8 ad fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b53:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b59:	e8 92 0b 00 00       	call   801046f0 <popcli>
  if((np = allocproc()) == 0){
...
80103b78:	e8 a3 36 00 00       	call   80107220 <copyuvm>
...
80103c66:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c69:	e8 92 fc ff ff       	call   80103900 <mycpu>
  c->proc = 0;
...
80103c8e:	e8 5d 0b 00 00       	call   801047f0 <acquire>
...
80103cb0:	e8 1b 30 00 00       	call   80106cd0 <switchuvm>
...
80103cbb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cc2:	e8 04 0e 00 00       	call   80104acb <swtch>
      switchkvm();
80103cc7:	e8 f4 2f 00 00       	call   80106cc0 <switchkvm>
      c->proc = 0;
...
80103d63:	e8 63 0d 00 00       	call   80104acb <swtch>
  mycpu()->intena = intena;
...
80103dc9:	e8 b2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dce:	39 05 54 55 11 80    	cmp    %eax,0x80115554
...
80103e2a:	e8 c1 09 00 00       	call   801047f0 <acquire>
...
80103e40:	05 e0 00 00 00       	add    $0xe0,%eax
80103e45:	3d 54 55 11 80       	cmp    $0x80115554,%eax
...
80103e57:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e5e:	05 e0 00 00 00       	add    $0xe0,%eax
80103e63:	3d 54 55 11 80       	cmp    $0x80115554,%eax
80103e68:	75 e2                	jne    80103e4c <exit+0x8c>
      p->parent = initproc;
80103e6a:	8b 0d 54 55 11 80    	mov    0x80115554,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e80:	81 c2 e0 00 00 00    	add    $0xe0,%edx
80103e86:	81 fa 54 55 11 80    	cmp    $0x80115554,%edx
...
80103ea7:	90                   	nop
80103ea8:	05 e0 00 00 00       	add    $0xe0,%eax
80103ead:	3d 54 55 11 80       	cmp    $0x80115554,%eax
...
80103ed7:	68 48 7a 10 80       	push   $0x80107a48
80103edc:	e8 9f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ee1:	83 ec 0c             	sub    $0xc,%esp
80103ee4:	68 3b 7a 10 80       	push   $0x80107a3b
...
80103f27:	90                   	nop
80103f28:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
80103f2e:	81 fb 54 55 11 80    	cmp    $0x80115554,%ebx
...
80103f3f:	74 5f                	je     80103fa0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f41:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
      havekids = 1;
80103f47:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f4c:	81 fb 54 55 11 80    	cmp    $0x80115554,%ebx
...
80103f61:	0f 85 8f 00 00 00    	jne    80103ff6 <wait+0x106>
  pushcli();
80103f67:	e8 34 07 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80103f6c:	e8 8f f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f71:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f77:	e8 74 07 00 00       	call   801046f0 <popcli>
  if(p == 0)
...
80103fb9:	e8 f2 30 00 00       	call   801070b0 <freevm>
        p->pid = 0;
...
80103fe5:	e8 a6 07 00 00       	call   80104790 <release>
        return pid;
...
8010402c:	e8 bf 07 00 00       	call   801047f0 <acquire>
  pushcli();
80104031:	e8 6a 06 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80104036:	e8 c5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010403b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104041:	e8 aa 06 00 00       	call   801046f0 <popcli>
...
80104059:	e8 32 07 00 00       	call   80104790 <release>
}
...
8010407c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010407f:	e8 1c 06 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80104084:	e8 77 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104089:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010408f:	e8 5c 06 00 00       	call   801046f0 <popcli>
  if(p == 0)
...
801040b0:	e8 3b 07 00 00       	call   801047f0 <acquire>
    release(lk);
801040b5:	89 34 24             	mov    %esi,(%esp)
801040b8:	e8 d3 06 00 00       	call   80104790 <release>
  p->chan = chan;
...
801040da:	e8 b1 06 00 00       	call   80104790 <release>
    acquire(lk);
...
801040eb:	5d                   	pop    %ebp
    acquire(lk);
801040ec:	e9 ff 06 00 00       	jmp    801047f0 <acquire>
...
80104119:	68 5a 7a 10 80       	push   $0x80107a5a
8010411e:	e8 5d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104123:	83 ec 0c             	sub    $0xc,%esp
80104126:	68 54 7a 10 80       	push   $0x80107a54
...
8010413f:	e8 ac 06 00 00       	call   801047f0 <acquire>
...
80104150:	05 e0 00 00 00       	add    $0xe0,%eax
80104155:	3d 54 55 11 80       	cmp    $0x80115554,%eax
...
80104167:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010416e:	05 e0 00 00 00       	add    $0xe0,%eax
80104173:	3d 54 55 11 80       	cmp    $0x80115554,%eax
80104178:	75 e2                	jne    8010415c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010417a:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
80104181:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104184:	c9                   	leave  
  release(&ptable.lock);
80104185:	e9 06 06 00 00       	jmp    80104790 <release>
...
8010419f:	e8 4c 06 00 00       	call   801047f0 <acquire>
...
801041b5:	3d 54 55 11 80       	cmp    $0x80115554,%eax
...
801041d8:	68 20 1d 11 80       	push   $0x80111d20
801041dd:	e8 ae 05 00 00       	call   80104790 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041f8:	e8 93 05 00 00       	call   80104790 <release>
}
...
8010422b:	68 8e 7a 10 80       	push   $0x80107a8e
80104230:	e8 6b c4 ff ff       	call   801006a0 <cprintf>
80104235:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104238:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
8010423e:	81 fb c0 55 11 80    	cmp    $0x801155c0,%ebx
...
8010424f:	74 e7                	je     80104238 <procdump+0x28>
      state = "???";
80104251:	ba 6b 7a 10 80       	mov    $0x80107a6b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104256:	83 f8 05             	cmp    $0x5,%eax
80104259:	77 11                	ja     8010426c <procdump+0x5c>
8010425b:	8b 14 85 0c 7b 10 80 	mov    -0x7fef84f4(,%eax,4),%edx
      state = "???";
80104262:	b8 6b 7a 10 80       	mov    $0x80107a6b,%eax
...
80104271:	68 6f 7a 10 80       	push   $0x80107a6f
...
80104298:	e8 a3 03 00 00       	call   80104640 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042ad:	68 c1 74 10 80       	push   $0x801074c1
...
801042d0 <find_next_prime_number>:
...
801042de:	66 90                	xchg   %ax,%ax
      n++;
801042e0:	83 c3 01             	add    $0x1,%ebx
      temp = 1;
      int i;
      for( i=2; i <= n/i; i++){
801042e3:	83 fb 03             	cmp    $0x3,%ebx
801042e6:	7e 20                	jle    80104308 <find_next_prime_number+0x38>
          if( n%i == 0 ){
801042e8:	f6 c3 01             	test   $0x1,%bl
801042eb:	74 f3                	je     801042e0 <find_next_prime_number+0x10>
      for( i=2; i <= n/i; i++){
801042ed:	b9 02 00 00 00       	mov    $0x2,%ecx
801042f2:	eb 08                	jmp    801042fc <find_next_prime_number+0x2c>
801042f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          if( n%i == 0 ){
801042f8:	85 d2                	test   %edx,%edx
801042fa:	74 e4                	je     801042e0 <find_next_prime_number+0x10>
      for( i=2; i <= n/i; i++){
801042fc:	89 d8                	mov    %ebx,%eax
801042fe:	83 c1 01             	add    $0x1,%ecx
80104301:	99                   	cltd   
80104302:	f7 f9                	idiv   %ecx
80104304:	39 c8                	cmp    %ecx,%eax
80104306:	7d f0                	jge    801042f8 <find_next_prime_number+0x28>
          } 
      }
      if(temp) is_prime = 1;
  }
...
80104313:	57                   	push   %edi
  ...
  int pid_max = -1;
  int cnt_max = -1;
80104314:	bf ff ff ff ff       	mov    $0xffffffff,%edi
{
80104319:	56                   	push   %esi
8010431a:	53                   	push   %ebx
8010431b:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
80104320:	83 ec 28             	sub    $0x28,%esp
  acquire(&ptable.lock);
80104323:	68 20 1d 11 80       	push   $0x80111d20
80104328:	e8 c3 04 00 00       	call   801047f0 <acquire>
  cprintf("Kernel: The list of onging processes:\n");
8010432d:	c7 04 24 e4 7a 10 80 	movl   $0x80107ae4,(%esp)
...
80104339:	8b 45 08             	mov    0x8(%ebp),%eax
  int pid_max = -1;
8010433c:	c7 45 e0 ff ff ff ff 	movl   $0xffffffff,-0x20(%ebp)
80104343:	83 c4 10             	add    $0x10,%esp
    int cnt = *(sys_cnt+sys_num-1);
80104346:	8d 0c 85 fc ff ff ff 	lea    -0x4(,%eax,4),%ecx
8010434d:	eb 1b                	jmp    8010436a <get_most_caller+0x5a>
8010434f:	90                   	nop
    if(p->pid !=0)
      cprintf("     pid=%d, name: %s \n",p->pid, p->name);
    if(cnt >= cnt_max){
80104350:	39 fe                	cmp    %edi,%esi
80104352:	7c 08                	jl     8010435c <get_most_caller+0x4c>
      cnt_max = cnt;
      pid_max = p->pid;
80104354:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80104357:	89 f7                	mov    %esi,%edi
80104359:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010435c:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
80104362:	81 fb c0 55 11 80    	cmp    $0x801155c0,%ebx
80104368:	74 26                	je     80104390 <get_most_caller+0x80>
    if(p->pid !=0)
8010436a:	8b 43 a4             	mov    -0x5c(%ebx),%eax
    int cnt = *(sys_cnt+sys_num-1);
8010436d:	8b 74 0b 10          	mov    0x10(%ebx,%ecx,1),%esi
    if(p->pid !=0)
80104371:	85 c0                	test   %eax,%eax
80104373:	74 db                	je     80104350 <get_most_caller+0x40>
      cprintf("     pid=%d, name: %s \n",p->pid, p->name);
80104375:	83 ec 04             	sub    $0x4,%esp
80104378:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
8010437b:	53                   	push   %ebx
8010437c:	50                   	push   %eax
8010437d:	68 78 7a 10 80       	push   $0x80107a78
80104382:	e8 19 c3 ff ff       	call   801006a0 <cprintf>
80104387:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010438a:	83 c4 10             	add    $0x10,%esp
8010438d:	eb c1                	jmp    80104350 <get_most_caller+0x40>
8010438f:	90                   	nop
    }
...
801043b9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801043bc:	e8 df 02 00 00       	call   801046a0 <pushcli>
  c = mycpu();
801043c1:	e8 3a f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801043c6:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
801043cc:	e8 1f 03 00 00       	call   801046f0 <popcli>
  struct proc *p;
  struct proc *curproc = myproc();
  int exist=0;
  acquire(&ptable.lock);
801043d1:	83 ec 0c             	sub    $0xc,%esp
801043d4:	68 20 1d 11 80       	push   $0x80111d20
801043d9:	e8 12 04 00 00       	call   801047f0 <acquire>
801043de:	83 c4 10             	add    $0x10,%esp
  for(;;){
    exist=0;
801043e1:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043e3:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801043e8:	eb 14                	jmp    801043fe <wait_for_process+0x4e>
801043ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801043f0:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
801043f6:	81 fb 54 55 11 80    	cmp    $0x80115554,%ebx
801043fc:	74 1e                	je     8010441c <wait_for_process+0x6c>
      if(p->pid == proc_pid)
801043fe:	39 73 10             	cmp    %esi,0x10(%ebx)
80104401:	75 ed                	jne    801043f0 <wait_for_process+0x40>
        exist = 1;
      if(p->state == ZOMBIE && p->pid == proc_pid){
80104403:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104407:	74 67                	je     80104470 <wait_for_process+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104409:	81 c3 e0 00 00 00    	add    $0xe0,%ebx
        exist = 1;
8010440f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104414:	81 fb 54 55 11 80    	cmp    $0x80115554,%ebx
8010441a:	75 e2                	jne    801043fe <wait_for_process+0x4e>
        p->state = UNUSED;
        release(&ptable.lock);
        return proc_pid;
      }
...
8010441e:	0f 84 a0 00 00 00    	je     801044c4 <wait_for_process+0x114>
80104424:	8b 47 24             	mov    0x24(%edi),%eax
80104427:	85 c0                	test   %eax,%eax
80104429:	0f 85 95 00 00 00    	jne    801044c4 <wait_for_process+0x114>
  pushcli();
8010442f:	e8 6c 02 00 00       	call   801046a0 <pushcli>
  c = mycpu();
80104434:	e8 c7 f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104439:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010443f:	e8 ac 02 00 00       	call   801046f0 <popcli>
  if(p == 0)
80104444:	85 db                	test   %ebx,%ebx
80104446:	0f 84 8f 00 00 00    	je     801044db <wait_for_process+0x12b>
  p->chan = chan;
8010444c:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
8010444f:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104456:	e8 a5 f8 ff ff       	call   80103d00 <sched>
  p->chan = 0;
8010445b:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80104462:	e9 7a ff ff ff       	jmp    801043e1 <wait_for_process+0x31>
80104467:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010446e:	66 90                	xchg   %ax,%ax
        kfree(p->kstack);
80104470:	83 ec 0c             	sub    $0xc,%esp
80104473:	ff 73 08             	push   0x8(%ebx)
80104476:	e8 45 e0 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
8010447b:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104482:	5a                   	pop    %edx
80104483:	ff 73 04             	push   0x4(%ebx)
80104486:	e8 25 2c 00 00       	call   801070b0 <freevm>
        p->pid = 0;
8010448b:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
...
801044a4:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801044ab:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801044b2:	e8 d9 02 00 00       	call   80104790 <release>
        return proc_pid;
...
801044c7:	68 20 1d 11 80       	push   $0x80111d20
801044cc:	e8 bf 02 00 00       	call   80104790 <release>
      return -1;
801044d1:	83 c4 10             	add    $0x10,%esp
801044d4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044d9:	eb e1                	jmp    801044bc <wait_for_process+0x10c>
    panic("sleep");
801044db:	83 ec 0c             	sub    $0xc,%esp
801044de:	68 54 7a 10 80       	push   $0x80107a54
...
801044fa:	68 24 7b 10 80       	push   $0x80107b24
...
80104555:	e8 16 fb ff ff       	call   80104070 <sleep>
  while (lk->locked) {
...
80104563:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104569:	e8 12 f4 ff ff       	call   80103980 <myproc>
...
801045b4:	e8 77 fb ff ff       	call   80104130 <wakeup>
  release(&lk->lk);
...
8010460b:	e8 70 f3 ff ff       	call   80103980 <myproc>
...
801046ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801046d0:	e8 2b f2 ff ff       	call   80103900 <mycpu>
...
801046fb:	75 35                	jne    80104732 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
801046fd:	e8 fe f1 ff ff       	call   80103900 <mycpu>
...
8010471c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104720:	e8 db f1 ff ff       	call   80103900 <mycpu>
...
80104735:	68 2f 7b 10 80       	push   $0x80107b2f
8010473a:	e8 41 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010473f:	83 ec 0c             	sub    $0xc,%esp
80104742:	68 46 7b 10 80       	push   $0x80107b46
...
80104773:	e8 88 f1 ff ff       	call   80103900 <mycpu>
...
801047ab:	68 4d 7b 10 80       	push   $0x80107b4d
...
8010482c:	e8 cf f0 ff ff       	call   80103900 <mycpu>
...
801048a0:	68 55 7b 10 80       	push   $0x80107b55
...
80104ae7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104aea:	e8 91 ee ff ff       	call   80103980 <myproc>
...
80104bc6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104bc9:	e8 b2 ed ff ff       	call   80103980 <myproc>
80104bce:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104bd0:	e8 ab ed ff ff       	call   80103980 <myproc>
...
80104bde:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104be1:	e8 9a ed ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c34:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c35:	e8 46 ed ff ff       	call   80103980 <myproc>
...
80104c43:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c46:	e8 35 ed ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c5b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104c5e:	e8 1d ed ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104cb4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104cb7:	e8 c4 ec ff ff       	call   80103980 <myproc>
...
80104cc7:	83 fa 18             	cmp    $0x18,%edx
80104cca:	77 24                	ja     80104cf0 <syscall+0x40>
80104ccc:	8b 14 85 80 7b 10 80 	mov    -0x7fef8480(,%eax,4),%edx
80104cd3:	85 d2                	test   %edx,%edx
80104cd5:	74 19                	je     80104cf0 <syscall+0x40>
    *(cntsys + num -1 ) = *(cntsys+num-1)+1;
80104cd7:	83 44 83 78 01       	addl   $0x1,0x78(%ebx,%eax,4)
    curproc->tf->eax = syscalls[num]();
80104cdc:	ff d2                	call   *%edx
80104cde:	89 c2                	mov    %eax,%edx
80104ce0:	8b 43 18             	mov    0x18(%ebx),%eax
80104ce3:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104cf8:	68 5d 7b 10 80       	push   $0x80107b5d
...
80104d37:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104d3a:	e8 81 d3 ff ff       	call   801020c0 <nameiparent>
...
80104d50:	e8 2b ca ff ff       	call   80101780 <ilock>
...
80104d5c:	e8 7f cf ff ff       	call   80101ce0 <dirlookup>
...
80104d6e:	e8 9d cc ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104d73:	89 34 24             	mov    %esi,(%esp)
80104d76:	e8 05 ca ff ff       	call   80101780 <ilock>
...
80104da4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104da6:	e8 65 cc ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104dc8:	ff 33                	push   (%ebx)
80104dca:	e8 41 c8 ff ff       	call   80101610 <ialloc>
...
80104de0:	e8 9b c9 ff ff       	call   80101780 <ilock>
  ip->major = major;
...
80104e01:	e8 ca c8 ff ff       	call   801016d0 <iupdate>
...
80104e13:	ff 76 04             	push   0x4(%esi)
80104e16:	57                   	push   %edi
80104e17:	53                   	push   %ebx
80104e18:	e8 c3 d1 ff ff       	call   80101fe0 <dirlink>
...
80104e28:	e8 e3 cb ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104e49:	e8 82 c8 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104e4e:	83 c4 0c             	add    $0xc,%esp
80104e51:	ff 76 04             	push   0x4(%esi)
80104e54:	68 04 7c 10 80       	push   $0x80107c04
80104e59:	56                   	push   %esi
80104e5a:	e8 81 d1 ff ff       	call   80101fe0 <dirlink>
...
80104e69:	ff 73 04             	push   0x4(%ebx)
80104e6c:	68 03 7c 10 80       	push   $0x80107c03
80104e71:	56                   	push   %esi
80104e72:	e8 69 d1 ff ff       	call   80101fe0 <dirlink>
...
80104e81:	68 f7 7b 10 80       	push   $0x80107bf7
...
80104e9f:	68 06 7c 10 80       	push   $0x80107c06
80104ea4:	e8 d7 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ea9:	83 ec 0c             	sub    $0xc,%esp
80104eac:	68 e8 7b 10 80       	push   $0x80107be8
...
80104ece:	e8 9d fc ff ff       	call   80104b70 <argint>
80104ed3:	83 c4 10             	add    $0x10,%esp
80104ed6:	85 c0                	test   %eax,%eax
80104ed8:	78 36                	js     80104f10 <sys_dup+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104eda:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104ede:	77 30                	ja     80104f10 <sys_dup+0x50>
...
80104f06:	74 18                	je     80104f20 <sys_dup+0x60>
  for(fd = 0; fd < NOFILE; fd++){
80104f08:	83 c3 01             	add    $0x1,%ebx
80104f0b:	83 fb 10             	cmp    $0x10,%ebx
80104f0e:	75 f0                	jne    80104f00 <sys_dup+0x40>
}
80104f10:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80104f13:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80104f20:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104f23:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80104f27:	56                   	push   %esi
80104f28:	e8 73 bf ff ff       	call   80100ea0 <filedup>
  return fd;
...
80104f4e:	e8 1d fc ff ff       	call   80104b70 <argint>
80104f53:	83 c4 10             	add    $0x10,%esp
80104f56:	85 c0                	test   %eax,%eax
80104f58:	78 5e                	js     80104fb8 <sys_read+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104f5a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104f5e:	77 58                	ja     80104fb8 <sys_read+0x78>
...
80104fbd:	eb ed                	jmp    80104fac <sys_read+0x6c>
80104fbf:	90                   	nop
...
80104fce:	e8 9d fb ff ff       	call   80104b70 <argint>
80104fd3:	83 c4 10             	add    $0x10,%esp
80104fd6:	85 c0                	test   %eax,%eax
80104fd8:	78 5e                	js     80105038 <sys_write+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104fda:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104fde:	77 58                	ja     80105038 <sys_write+0x78>
...
8010503d:	eb ed                	jmp    8010502c <sys_write+0x6c>
8010503f:	90                   	nop
...
8010504e:	e8 1d fb ff ff       	call   80104b70 <argint>
80105053:	83 c4 10             	add    $0x10,%esp
80105056:	85 c0                	test   %eax,%eax
80105058:	78 3e                	js     80105098 <sys_close+0x58>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010505a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010505e:	77 38                	ja     80105098 <sys_close+0x58>
80105060:	e8 1b e9 ff ff       	call   80103980 <myproc>
80105065:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105068:	8d 5a 08             	lea    0x8(%edx),%ebx
8010506b:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
8010506f:	85 f6                	test   %esi,%esi
80105071:	74 25                	je     80105098 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105073:	e8 08 e9 ff ff       	call   80103980 <myproc>
  fileclose(f);
80105078:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
8010507b:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
80105082:	00 
  fileclose(f);
80105083:	56                   	push   %esi
80105084:	e8 67 be ff ff       	call   80100ef0 <fileclose>
  return 0;
...
8010509d:	eb ef                	jmp    8010508e <sys_close+0x4e>
8010509f:	90                   	nop
...
80105105:	eb ec                	jmp    801050f3 <sys_fstat+0x53>
...
80105115:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
...
8010511f:	e8 0c fb ff ff       	call   80104c30 <argstr>
...
80105132:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105135:	50                   	push   %eax
80105136:	6a 01                	push   $0x1
80105138:	e8 f3 fa ff ff       	call   80104c30 <argstr>
8010513d:	83 c4 10             	add    $0x10,%esp
80105140:	85 c0                	test   %eax,%eax
80105142:	0f 88 e2 00 00 00    	js     8010522a <sys_link+0x11a>
  begin_op();
80105148:	e8 13 dc ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
8010514d:	83 ec 0c             	sub    $0xc,%esp
80105150:	ff 75 d4             	push   -0x2c(%ebp)
80105153:	e8 48 cf ff ff       	call   801020a0 <namei>
80105158:	83 c4 10             	add    $0x10,%esp
8010515b:	89 c3                	mov    %eax,%ebx
8010515d:	85 c0                	test   %eax,%eax
8010515f:	0f 84 e4 00 00 00    	je     80105249 <sys_link+0x139>
  ilock(ip);
80105165:	83 ec 0c             	sub    $0xc,%esp
80105168:	50                   	push   %eax
80105169:	e8 12 c6 ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
8010516e:	83 c4 10             	add    $0x10,%esp
80105171:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105176:	0f 84 b5 00 00 00    	je     80105231 <sys_link+0x121>
  iupdate(ip);
8010517c:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
8010517f:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105184:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80105187:	53                   	push   %ebx
80105188:	e8 43 c5 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
8010518d:	89 1c 24             	mov    %ebx,(%esp)
80105190:	e8 cb c6 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105195:	58                   	pop    %eax
80105196:	5a                   	pop    %edx
80105197:	57                   	push   %edi
80105198:	ff 75 d0             	push   -0x30(%ebp)
8010519b:	e8 20 cf ff ff       	call   801020c0 <nameiparent>
...
801051be:	ff 73 04             	push   0x4(%ebx)
801051c1:	57                   	push   %edi
801051c2:	56                   	push   %esi
801051c3:	e8 18 ce ff ff       	call   80101fe0 <dirlink>
...
801051d3:	e8 38 c8 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
801051d8:	89 1c 24             	mov    %ebx,(%esp)
801051db:	e8 d0 c6 ff ff       	call   801018b0 <iput>
  end_op();
801051e0:	e8 eb db ff ff       	call   80102dd0 <end_op>
  return 0;
...
801051fc:	e8 0f c8 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105215:	e8 b6 c4 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010521a:	89 1c 24             	mov    %ebx,(%esp)
8010521d:	e8 ee c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105222:	e8 a9 db ff ff       	call   80102dd0 <end_op>
  return -1;
80105227:	83 c4 10             	add    $0x10,%esp
8010522a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010522f:	eb b9                	jmp    801051ea <sys_link+0xda>
    iunlockput(ip);
80105231:	83 ec 0c             	sub    $0xc,%esp
80105234:	53                   	push   %ebx
80105235:	e8 d6 c7 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010523a:	e8 91 db ff ff       	call   80102dd0 <end_op>
    return -1;
8010523f:	83 c4 10             	add    $0x10,%esp
80105242:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105247:	eb a1                	jmp    801051ea <sys_link+0xda>
    end_op();
80105249:	e8 82 db ff ff       	call   80102dd0 <end_op>
    return -1;
8010524e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105253:	eb 95                	jmp    801051ea <sys_link+0xda>
80105255:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105264:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105265:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
80105268:	53                   	push   %ebx
80105269:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
8010526c:	50                   	push   %eax
8010526d:	6a 00                	push   $0x0
8010526f:	e8 bc f9 ff ff       	call   80104c30 <argstr>
80105274:	83 c4 10             	add    $0x10,%esp
80105277:	85 c0                	test   %eax,%eax
80105279:	0f 88 7a 01 00 00    	js     801053f9 <sys_unlink+0x199>
  begin_op();
8010527f:	e8 dc da ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105284:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105287:	83 ec 08             	sub    $0x8,%esp
8010528a:	53                   	push   %ebx
8010528b:	ff 75 c0             	push   -0x40(%ebp)
8010528e:	e8 2d ce ff ff       	call   801020c0 <nameiparent>
80105293:	83 c4 10             	add    $0x10,%esp
80105296:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105299:	85 c0                	test   %eax,%eax
8010529b:	0f 84 62 01 00 00    	je     80105403 <sys_unlink+0x1a3>
  ilock(dp);
801052a1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
...
801052e7:	e8 f4 c9 ff ff       	call   80101ce0 <dirlookup>
801052ec:	83 c4 10             	add    $0x10,%esp
801052ef:	89 c3                	mov    %eax,%ebx
801052f1:	85 c0                	test   %eax,%eax
801052f3:	0f 84 c7 00 00 00    	je     801053c0 <sys_unlink+0x160>
  ilock(ip);
...
8010530a:	0f 8e 1c 01 00 00    	jle    8010542c <sys_unlink+0x1cc>
...
80105322:	e8 89 f5 ff ff       	call   801048b0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105327:	6a 10                	push   $0x10
80105329:	ff 75 c4             	push   -0x3c(%ebp)
8010532c:	57                   	push   %edi
8010532d:	ff 75 b4             	push   -0x4c(%ebp)
80105330:	e8 5b c8 ff ff       	call   80101b90 <writei>
80105335:	83 c4 20             	add    $0x20,%esp
80105338:	83 f8 10             	cmp    $0x10,%eax
8010533b:	0f 85 de 00 00 00    	jne    8010541f <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105341:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105346:	0f 84 94 00 00 00    	je     801053e0 <sys_unlink+0x180>
  iunlockput(dp);
8010534c:	83 ec 0c             	sub    $0xc,%esp
8010534f:	ff 75 b4             	push   -0x4c(%ebp)
80105352:	e8 b9 c6 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
80105357:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010535c:	89 1c 24             	mov    %ebx,(%esp)
8010535f:	e8 6c c3 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105364:	89 1c 24             	mov    %ebx,(%esp)
80105367:	e8 a4 c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010536c:	e8 5f da ff ff       	call   80102dd0 <end_op>
  return 0;
80105371:	83 c4 10             	add    $0x10,%esp
80105374:	31 c0                	xor    %eax,%eax
}
80105376:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105379:	5b                   	pop    %ebx
8010537a:	5e                   	pop    %esi
8010537b:	5f                   	pop    %edi
8010537c:	5d                   	pop    %ebp
...
80105386:	be 20 00 00 00       	mov    $0x20,%esi
8010538b:	eb 0b                	jmp    80105398 <sys_unlink+0x138>
8010538d:	8d 76 00             	lea    0x0(%esi),%esi
80105390:	83 c6 10             	add    $0x10,%esi
80105393:	3b 73 58             	cmp    0x58(%ebx),%esi
80105396:	73 82                	jae    8010531a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105398:	6a 10                	push   $0x10
8010539a:	56                   	push   %esi
8010539b:	57                   	push   %edi
8010539c:	53                   	push   %ebx
8010539d:	e8 ee c6 ff ff       	call   80101a90 <readi>
801053a2:	83 c4 10             	add    $0x10,%esp
801053a5:	83 f8 10             	cmp    $0x10,%eax
801053a8:	75 68                	jne    80105412 <sys_unlink+0x1b2>
    if(de.inum != 0)
801053aa:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801053af:	74 df                	je     80105390 <sys_unlink+0x130>
    iunlockput(ip);
...
801053c3:	ff 75 b4             	push   -0x4c(%ebp)
801053c6:	e8 45 c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
801053cb:	e8 00 da ff ff       	call   80102dd0 <end_op>
  return -1;
801053d0:	83 c4 10             	add    $0x10,%esp
801053d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053d8:	eb 9c                	jmp    80105376 <sys_unlink+0x116>
801053da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
801053e0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
801053e3:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801053e6:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801053eb:	50                   	push   %eax
801053ec:	e8 df c2 ff ff       	call   801016d0 <iupdate>
801053f1:	83 c4 10             	add    $0x10,%esp
801053f4:	e9 53 ff ff ff       	jmp    8010534c <sys_unlink+0xec>
    return -1;
801053f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053fe:	e9 73 ff ff ff       	jmp    80105376 <sys_unlink+0x116>
    end_op();
80105403:	e8 c8 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
80105408:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010540d:	e9 64 ff ff ff       	jmp    80105376 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105412:	83 ec 0c             	sub    $0xc,%esp
80105415:	68 28 7c 10 80       	push   $0x80107c28
8010541a:	e8 61 af ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010541f:	83 ec 0c             	sub    $0xc,%esp
80105422:	68 3a 7c 10 80       	push   $0x80107c3a
80105427:	e8 54 af ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010542c:	83 ec 0c             	sub    $0xc,%esp
8010542f:	68 16 7c 10 80       	push   $0x80107c16
...
8010544f:	e8 dc f7 ff ff       	call   80104c30 <argstr>
...
80105468:	e8 03 f7 ff ff       	call   80104b70 <argint>
...
80105472:	78 79                	js     801054ed <sys_open+0xad>
  ...
  begin_op();
80105474:	e8 e7 d8 ff ff       	call   80102d60 <begin_op>
...
80105485:	e8 16 cc ff ff       	call   801020a0 <namei>
...
8010549b:	e8 e0 c2 ff ff       	call   80101780 <ilock>
...
801054d4:	e8 17 ba ff ff       	call   80100ef0 <fileclose>
801054d9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801054dc:	83 ec 0c             	sub    $0xc,%esp
801054df:	56                   	push   %esi
801054e0:	e8 2b c5 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105507:	e8 14 f8 ff ff       	call   80104d20 <create>
    if(ip == 0){
...
80105530:	e8 2b c3 ff ff       	call   80101860 <iunlock>
  end_op();
...
80105594:	e8 97 f6 ff ff       	call   80104c30 <argstr>
...
801055af:	e8 6c f7 ff ff       	call   80104d20 <create>
...
801055bf:	e8 4c c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
801055c4:	e8 07 d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801055f4:	e8 37 f6 ff ff       	call   80104c30 <argstr>
...
80105609:	e8 62 f5 ff ff       	call   80104b70 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010561e:	e8 4d f5 ff ff       	call   80104b70 <argint>
     argint(1, &major) < 0 ||
...
8010563e:	e8 dd f6 ff ff       	call   80104d20 <create>
     argint(2, &minor) < 0 ||
...
8010564e:	e8 bd c3 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105653:	e8 78 d7 ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010568d:	e8 9e f5 ff ff       	call   80104c30 <argstr>
...
8010569f:	e8 fc c9 ff ff       	call   801020a0 <namei>
...
801056b1:	e8 ca c0 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
801056c4:	e8 97 c1 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
801056c9:	58                   	pop    %eax
801056ca:	ff 76 68             	push   0x68(%esi)
801056cd:	e8 de c1 ff ff       	call   801018b0 <iput>
  end_op();
...
801056f4:	e8 17 c3 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105735:	e8 f6 f4 ff ff       	call   80104c30 <argstr>
...
80105751:	e8 1a f4 ff ff       	call   80104b70 <argint>
...
80105770:	e8 3b f1 ff ff       	call   801048b0 <memset>
...
8010579a:	e8 41 f3 ff ff       	call   80104ae0 <fetchint>
...
801057b8:	e8 63 f3 ff ff       	call   80104b20 <fetchstr>
...
80105821:	e8 9a f3 ff ff       	call   80104bc0 <argptr>
...
80105838:	e8 f3 db ff ff       	call   80103430 <pipealloc>
...
80105844:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105847:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105849:	e8 32 e1 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010584e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105850:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80105854:	85 f6                	test   %esi,%esi
80105856:	74 28                	je     80105880 <sys_pipe+0x70>
  for(fd = 0; fd < NOFILE; fd++){
...
80105863:	ff 75 e0             	push   -0x20(%ebp)
80105866:	e8 85 b6 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
8010586b:	58                   	pop    %eax
8010586c:	ff 75 e4             	push   -0x1c(%ebp)
8010586f:	e8 7c b6 ff ff       	call   80100ef0 <fileclose>
    return -1;
80105874:	83 c4 10             	add    $0x10,%esp
80105877:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010587c:	eb 53                	jmp    801058d1 <sys_pipe+0xc1>
...
80105887:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010588a:	e8 f1 e0 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010589e:	74 20                	je     801058c0 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
801058a0:	83 c2 01             	add    $0x1,%edx
801058a3:	83 fa 10             	cmp    $0x10,%edx
801058a6:	75 f0                	jne    80105898 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801058a8:	e8 d3 e0 ff ff       	call   80103980 <myproc>
801058ad:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801058b4:	00 
801058b5:	eb a9                	jmp    80105860 <sys_pipe+0x50>
...
{
  return fork();
801058e0:	e9 5b e2 ff ff       	jmp    80103b40 <fork>
...
801058f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801058f6:	e8 c5 e4 ff ff       	call   80103dc0 <exit>
...
{
  return wait();
80105900:	e9 eb e5 ff ff       	jmp    80103ef0 <wait>
...
8010591c:	e8 4f f2 ff ff       	call   80104b70 <argint>
...
8010592b:	ff 75 f4             	push   -0xc(%ebp)
8010592e:	e8 5d e8 ff ff       	call   80104190 <kill>
...
80105953:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105956:	e8 25 e0 ff ff       	call   80103980 <myproc>
...
8010596d:	e8 fe f1 ff ff       	call   80104b70 <argint>
...
80105986:	e8 35 e1 ff ff       	call   80103ac0 <growproc>
...
801059bd:	e8 ae f1 ff ff       	call   80104b70 <argint>
...
801059d0:	68 80 55 11 80       	push   $0x80115580
801059d5:	e8 16 ee ff ff       	call   801047f0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801059da:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801059dd:	8b 1d 60 55 11 80    	mov    0x80115560,%ebx
  while(ticks - ticks0 < n){
...
801059f3:	68 80 55 11 80       	push   $0x80115580
801059f8:	68 60 55 11 80       	push   $0x80115560
801059fd:	e8 6e e6 ff ff       	call   80104070 <sleep>
  while(ticks - ticks0 < n){
80105a02:	a1 60 55 11 80       	mov    0x80115560,%eax
...
80105a20:	68 80 55 11 80       	push   $0x80115580
80105a25:	e8 66 ed ff ff       	call   80104790 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105a43:	68 80 55 11 80       	push   $0x80115580
80105a48:	e8 43 ed ff ff       	call   80104790 <release>
  return 0;
...
80105a64:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a67:	68 80 55 11 80       	push   $0x80115580
80105a6c:	e8 7f ed ff ff       	call   801047f0 <acquire>
  xticks = ticks;
80105a71:	8b 1d 60 55 11 80    	mov    0x80115560,%ebx
  release(&tickslock);
80105a77:	c7 04 24 80 55 11 80 	movl   $0x80115580,(%esp)
80105a7e:	e8 0d ed ff ff       	call   80104790 <release>
  return xticks;
}
...
80105a90 <sys_find_next_prime_number>:
...
80105a97:	e8 e4 de ff ff       	call   80103980 <myproc>
  cprintf("Kernel: sys_find_next_prime_num() called for number %d\n", number);
80105a9c:	83 ec 08             	sub    $0x8,%esp
  int number = myproc()->tf->ebx; //register after eax
80105a9f:	8b 40 18             	mov    0x18(%eax),%eax
80105aa2:	8b 58 10             	mov    0x10(%eax),%ebx
  cprintf("Kernel: sys_find_next_prime_num() called for number %d\n", number);
80105aa5:	53                   	push   %ebx
80105aa6:	68 4c 7c 10 80       	push   $0x80107c4c
80105aab:	e8 f0 ab ff ff       	call   801006a0 <cprintf>
  return find_next_prime_number(number);
80105ab0:	89 1c 24             	mov    %ebx,(%esp)
80105ab3:	e8 18 e8 ff ff       	call   801042d0 <find_next_prime_number>
}
80105ab8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105abb:	c9                   	leave  
80105abc:	c3                   	ret    
80105abd:	8d 76 00             	lea    0x0(%esi),%esi

80105ac0 <sys_get_call_count>:
...
80105ac4:	83 ec 14             	sub    $0x14,%esp
  ...
  int sys_num;
  struct proc *curproc = myproc();
80105ac7:	e8 b4 de ff ff       	call   80103980 <myproc>
  argint(0, &sys_num);
...
80105ad7:	e8 94 f0 ff ff       	call   80104b70 <argint>
  cnt = curproc->syscnt;
  return *(cnt+sys_num-1);
80105adc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105adf:	8b 44 83 78          	mov    0x78(%ebx,%eax,4),%eax
}
80105ae3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105ae6:	c9                   	leave  
80105ae7:	c3                   	ret    
80105ae8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105aef:	90                   	nop

80105af0 <sys_get_most_caller>:
...
80105afc:	e8 6f f0 ff ff       	call   80104b70 <argint>
  return get_most_caller(sys_num);
80105b01:	58                   	pop    %eax
80105b02:	ff 75 f4             	push   -0xc(%ebp)
80105b05:	e8 06 e8 ff ff       	call   80104310 <get_most_caller>
}
80105b0a:	c9                   	leave  
80105b0b:	c3                   	ret    
80105b0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105b10 <sys_wait_for_process>:
...
80105b1c:	e8 4f f0 ff ff       	call   80104b70 <argint>
  return wait_for_process(pid);
80105b21:	58                   	pop    %eax
80105b22:	ff 75 f4             	push   -0xc(%ebp)
80105b25:	e8 86 e8 ff ff       	call   801043b0 <wait_for_process>
...
80105b2d:	06                   	push   %es
  pushl %fs
80105b2e:	0f a0                	push   %fs
  pushl %gs
80105b30:	0f a8                	push   %gs
  pushal
80105b32:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105b33:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105b37:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105b39:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105b3b:	54                   	push   %esp
  call trap
80105b3c:	e8 bf 00 00 00       	call   80105c00 <trap>
  addl $4, %esp
80105b41:	83 c4 04             	add    $0x4,%esp
...
80105b44:	61                   	popa   
  popl %gs
80105b45:	0f a9                	pop    %gs
  popl %fs
80105b47:	0f a1                	pop    %fs
  popl %es
80105b49:	07                   	pop    %es
  popl %ds
80105b4a:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105b4b:	83 c4 08             	add    $0x8,%esp
  iret
80105b4e:	cf                   	iret   
80105b4f:	90                   	nop
...
80105b67:	c7 04 c5 c2 55 11 80 	movl   $0x8e000008,-0x7feeaa3e(,%eax,8)
80105b6e:	08 00 00 8e 
80105b72:	66 89 14 c5 c0 55 11 	mov    %dx,-0x7feeaa40(,%eax,8)
80105b79:	80 
80105b7a:	c1 ea 10             	shr    $0x10,%edx
80105b7d:	66 89 14 c5 c6 55 11 	mov    %dx,-0x7feeaa3a(,%eax,8)
80105b84:	80 
  for(i = 0; i < 256; i++)
...
80105b97:	c7 05 c2 57 11 80 08 	movl   $0xef000008,0x801157c2
80105b9e:	00 00 ef 
  initlock(&tickslock, "time");
80105ba1:	68 84 7c 10 80       	push   $0x80107c84
80105ba6:	68 80 55 11 80       	push   $0x80115580
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105bab:	66 a3 c0 57 11 80    	mov    %ax,0x801157c0
80105bb1:	c1 e8 10             	shr    $0x10,%eax
80105bb4:	66 a3 c6 57 11 80    	mov    %ax,0x801157c6
  initlock(&tickslock, "time");
80105bba:	e8 61 ea ff ff       	call   80104620 <initlock>
}
...
80105bdb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105bdf:	b8 c0 55 11 80       	mov    $0x801155c0,%eax
...
80105c24:	ff 24 85 2c 7d 10 80 	jmp    *-0x7fef82d4(,%eax,4)
...
80105c43:	e8 38 dd ff ff       	call   80103980 <myproc>
...
80105c60:	e8 1b dd ff ff       	call   80103980 <myproc>
...
80105c72:	0f 84 b8 00 00 00    	je     80105d30 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c78:	e8 03 dd ff ff       	call   80103980 <myproc>
...
80105cd0:	e8 8b dc ff ff       	call   80103960 <cpuid>
...
80105ce1:	e8 9a dc ff ff       	call   80103980 <myproc>
...
80105d05:	68 e8 7c 10 80       	push   $0x80107ce8
80105d0a:	e8 91 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105d0f:	83 c4 20             	add    $0x20,%esp
80105d12:	e8 69 dc ff ff       	call   80103980 <myproc>
80105d17:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d1e:	e8 5d dc ff ff       	call   80103980 <myproc>
...
80105d34:	0f 85 3e ff ff ff    	jne    80105c78 <trap+0x78>
    yield();
80105d3a:	e8 e1 e2 ff ff       	call   80104020 <yield>
...
80105d57:	68 90 7c 10 80       	push   $0x80107c90
...
80105d7f:	90                   	nop
    if(myproc()->killed)
80105d80:	e8 fb db ff ff       	call   80103980 <myproc>
...
80105d95:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d98:	e8 13 ef ff ff       	call   80104cb0 <syscall>
    if(myproc()->killed)
80105d9d:	e8 de db ff ff       	call   80103980 <myproc>
...
80105db3:	5d                   	pop    %ebp
      exit();
80105db4:	e9 07 e0 ff ff       	jmp    80103dc0 <exit>
...
80105de5:	e8 26 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105dea:	e8 91 db ff ff       	call   80103980 <myproc>
...
80105dfc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105e00:	e8 5b db ff ff       	call   80103960 <cpuid>
80105e05:	85 c0                	test   %eax,%eax
80105e07:	0f 85 28 fe ff ff    	jne    80105c35 <trap+0x35>
      acquire(&tickslock);
80105e0d:	83 ec 0c             	sub    $0xc,%esp
80105e10:	68 80 55 11 80       	push   $0x80115580
80105e15:	e8 d6 e9 ff ff       	call   801047f0 <acquire>
      wakeup(&ticks);
80105e1a:	c7 04 24 60 55 11 80 	movl   $0x80115560,(%esp)
      ticks++;
80105e21:	83 05 60 55 11 80 01 	addl   $0x1,0x80115560
      wakeup(&ticks);
80105e28:	e8 03 e3 ff ff       	call   80104130 <wakeup>
      release(&tickslock);
80105e2d:	c7 04 24 80 55 11 80 	movl   $0x80115580,(%esp)
80105e34:	e8 57 e9 ff ff       	call   80104790 <release>
...
{
  if(!uart)
80105e90:	a1 c0 5d 11 80       	mov    0x80115dc0,%eax
...
80105f17:	74 78                	je     80105f91 <uartinit+0xd1>
  uart = 1;
80105f19:	c7 05 c0 5d 11 80 01 	movl   $0x1,0x80115dc0
80105f20:	00 00 00 
...
80105f2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f2f:	bf ac 7d 10 80       	mov    $0x80107dac,%edi
...
80105f49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105f50:	a1 c0 5d 11 80       	mov    0x80115dc0,%eax
...
80105fa0 <uartputc>:
  if(!uart)
80105fa0:	a1 c0 5d 11 80       	mov    0x80115dc0,%eax
...
80106017:	6a 00                	push   $0x0
  jmp alltraps
80106019:	e9 0e fb ff ff       	jmp    80105b2c <alltraps>
...
80106020:	6a 01                	push   $0x1
  jmp alltraps
80106022:	e9 05 fb ff ff       	jmp    80105b2c <alltraps>
...
80106029:	6a 02                	push   $0x2
  jmp alltraps
8010602b:	e9 fc fa ff ff       	jmp    80105b2c <alltraps>
...
80106032:	6a 03                	push   $0x3
  jmp alltraps
80106034:	e9 f3 fa ff ff       	jmp    80105b2c <alltraps>
...
8010603b:	6a 04                	push   $0x4
  jmp alltraps
8010603d:	e9 ea fa ff ff       	jmp    80105b2c <alltraps>
...
80106044:	6a 05                	push   $0x5
  jmp alltraps
80106046:	e9 e1 fa ff ff       	jmp    80105b2c <alltraps>
...
8010604d:	6a 06                	push   $0x6
  jmp alltraps
8010604f:	e9 d8 fa ff ff       	jmp    80105b2c <alltraps>
...
80106056:	6a 07                	push   $0x7
  jmp alltraps
80106058:	e9 cf fa ff ff       	jmp    80105b2c <alltraps>
...
8010605d:	6a 08                	push   $0x8
  jmp alltraps
8010605f:	e9 c8 fa ff ff       	jmp    80105b2c <alltraps>
...
80106066:	6a 09                	push   $0x9
  jmp alltraps
80106068:	e9 bf fa ff ff       	jmp    80105b2c <alltraps>
...
8010606d:	6a 0a                	push   $0xa
  jmp alltraps
8010606f:	e9 b8 fa ff ff       	jmp    80105b2c <alltraps>
...
80106074:	6a 0b                	push   $0xb
  jmp alltraps
80106076:	e9 b1 fa ff ff       	jmp    80105b2c <alltraps>
...
8010607b:	6a 0c                	push   $0xc
  jmp alltraps
8010607d:	e9 aa fa ff ff       	jmp    80105b2c <alltraps>
...
80106082:	6a 0d                	push   $0xd
  jmp alltraps
80106084:	e9 a3 fa ff ff       	jmp    80105b2c <alltraps>
...
80106089:	6a 0e                	push   $0xe
  jmp alltraps
8010608b:	e9 9c fa ff ff       	jmp    80105b2c <alltraps>
...
80106092:	6a 0f                	push   $0xf
  jmp alltraps
80106094:	e9 93 fa ff ff       	jmp    80105b2c <alltraps>
...
8010609b:	6a 10                	push   $0x10
  jmp alltraps
8010609d:	e9 8a fa ff ff       	jmp    80105b2c <alltraps>
...
801060a2:	6a 11                	push   $0x11
  jmp alltraps
801060a4:	e9 83 fa ff ff       	jmp    80105b2c <alltraps>
...
801060ab:	6a 12                	push   $0x12
  jmp alltraps
801060ad:	e9 7a fa ff ff       	jmp    80105b2c <alltraps>
...
801060b4:	6a 13                	push   $0x13
  jmp alltraps
801060b6:	e9 71 fa ff ff       	jmp    80105b2c <alltraps>
...
801060bd:	6a 14                	push   $0x14
  jmp alltraps
801060bf:	e9 68 fa ff ff       	jmp    80105b2c <alltraps>
...
801060c6:	6a 15                	push   $0x15
  jmp alltraps
801060c8:	e9 5f fa ff ff       	jmp    80105b2c <alltraps>
...
801060cf:	6a 16                	push   $0x16
  jmp alltraps
801060d1:	e9 56 fa ff ff       	jmp    80105b2c <alltraps>
...
801060d8:	6a 17                	push   $0x17
  jmp alltraps
801060da:	e9 4d fa ff ff       	jmp    80105b2c <alltraps>
...
801060e1:	6a 18                	push   $0x18
  jmp alltraps
801060e3:	e9 44 fa ff ff       	jmp    80105b2c <alltraps>
...
801060ea:	6a 19                	push   $0x19
  jmp alltraps
801060ec:	e9 3b fa ff ff       	jmp    80105b2c <alltraps>
...
801060f3:	6a 1a                	push   $0x1a
  jmp alltraps
801060f5:	e9 32 fa ff ff       	jmp    80105b2c <alltraps>
...
801060fc:	6a 1b                	push   $0x1b
  jmp alltraps
801060fe:	e9 29 fa ff ff       	jmp    80105b2c <alltraps>
...
80106105:	6a 1c                	push   $0x1c
  jmp alltraps
80106107:	e9 20 fa ff ff       	jmp    80105b2c <alltraps>
...
8010610e:	6a 1d                	push   $0x1d
  jmp alltraps
80106110:	e9 17 fa ff ff       	jmp    80105b2c <alltraps>
...
80106117:	6a 1e                	push   $0x1e
  jmp alltraps
80106119:	e9 0e fa ff ff       	jmp    80105b2c <alltraps>
...
80106120:	6a 1f                	push   $0x1f
  jmp alltraps
80106122:	e9 05 fa ff ff       	jmp    80105b2c <alltraps>
...
80106129:	6a 20                	push   $0x20
  jmp alltraps
8010612b:	e9 fc f9 ff ff       	jmp    80105b2c <alltraps>
...
80106132:	6a 21                	push   $0x21
  jmp alltraps
80106134:	e9 f3 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010613b:	6a 22                	push   $0x22
  jmp alltraps
8010613d:	e9 ea f9 ff ff       	jmp    80105b2c <alltraps>
...
80106144:	6a 23                	push   $0x23
  jmp alltraps
80106146:	e9 e1 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010614d:	6a 24                	push   $0x24
  jmp alltraps
8010614f:	e9 d8 f9 ff ff       	jmp    80105b2c <alltraps>
...
80106156:	6a 25                	push   $0x25
  jmp alltraps
80106158:	e9 cf f9 ff ff       	jmp    80105b2c <alltraps>
...
8010615f:	6a 26                	push   $0x26
  jmp alltraps
80106161:	e9 c6 f9 ff ff       	jmp    80105b2c <alltraps>
...
80106168:	6a 27                	push   $0x27
  jmp alltraps
8010616a:	e9 bd f9 ff ff       	jmp    80105b2c <alltraps>
...
80106171:	6a 28                	push   $0x28
  jmp alltraps
80106173:	e9 b4 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010617a:	6a 29                	push   $0x29
  jmp alltraps
8010617c:	e9 ab f9 ff ff       	jmp    80105b2c <alltraps>
...
80106183:	6a 2a                	push   $0x2a
  jmp alltraps
80106185:	e9 a2 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010618c:	6a 2b                	push   $0x2b
  jmp alltraps
8010618e:	e9 99 f9 ff ff       	jmp    80105b2c <alltraps>
...
80106195:	6a 2c                	push   $0x2c
  jmp alltraps
80106197:	e9 90 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010619e:	6a 2d                	push   $0x2d
  jmp alltraps
801061a0:	e9 87 f9 ff ff       	jmp    80105b2c <alltraps>
...
801061a7:	6a 2e                	push   $0x2e
  jmp alltraps
801061a9:	e9 7e f9 ff ff       	jmp    80105b2c <alltraps>
...
801061b0:	6a 2f                	push   $0x2f
  jmp alltraps
801061b2:	e9 75 f9 ff ff       	jmp    80105b2c <alltraps>
...
801061b9:	6a 30                	push   $0x30
  jmp alltraps
801061bb:	e9 6c f9 ff ff       	jmp    80105b2c <alltraps>
...
801061c2:	6a 31                	push   $0x31
  jmp alltraps
801061c4:	e9 63 f9 ff ff       	jmp    80105b2c <alltraps>
...
801061cb:	6a 32                	push   $0x32
  jmp alltraps
801061cd:	e9 5a f9 ff ff       	jmp    80105b2c <alltraps>
...
801061d4:	6a 33                	push   $0x33
  jmp alltraps
801061d6:	e9 51 f9 ff ff       	jmp    80105b2c <alltraps>
...
801061dd:	6a 34                	push   $0x34
  jmp alltraps
801061df:	e9 48 f9 ff ff       	jmp    80105b2c <alltraps>
...
801061e6:	6a 35                	push   $0x35
  jmp alltraps
801061e8:	e9 3f f9 ff ff       	jmp    80105b2c <alltraps>
...
801061ef:	6a 36                	push   $0x36
  jmp alltraps
801061f1:	e9 36 f9 ff ff       	jmp    80105b2c <alltraps>
...
801061f8:	6a 37                	push   $0x37
  jmp alltraps
801061fa:	e9 2d f9 ff ff       	jmp    80105b2c <alltraps>
...
80106201:	6a 38                	push   $0x38
  jmp alltraps
80106203:	e9 24 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010620a:	6a 39                	push   $0x39
  jmp alltraps
8010620c:	e9 1b f9 ff ff       	jmp    80105b2c <alltraps>
...
80106213:	6a 3a                	push   $0x3a
  jmp alltraps
80106215:	e9 12 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010621c:	6a 3b                	push   $0x3b
  jmp alltraps
8010621e:	e9 09 f9 ff ff       	jmp    80105b2c <alltraps>
...
80106225:	6a 3c                	push   $0x3c
  jmp alltraps
80106227:	e9 00 f9 ff ff       	jmp    80105b2c <alltraps>
...
8010622e:	6a 3d                	push   $0x3d
  jmp alltraps
80106230:	e9 f7 f8 ff ff       	jmp    80105b2c <alltraps>
...
80106237:	6a 3e                	push   $0x3e
  jmp alltraps
80106239:	e9 ee f8 ff ff       	jmp    80105b2c <alltraps>
...
80106240:	6a 3f                	push   $0x3f
  jmp alltraps
80106242:	e9 e5 f8 ff ff       	jmp    80105b2c <alltraps>
...
80106249:	6a 40                	push   $0x40
  jmp alltraps
8010624b:	e9 dc f8 ff ff       	jmp    80105b2c <alltraps>
...
80106252:	6a 41                	push   $0x41
  jmp alltraps
80106254:	e9 d3 f8 ff ff       	jmp    80105b2c <alltraps>
...
8010625b:	6a 42                	push   $0x42
  jmp alltraps
8010625d:	e9 ca f8 ff ff       	jmp    80105b2c <alltraps>
...
80106264:	6a 43                	push   $0x43
  jmp alltraps
80106266:	e9 c1 f8 ff ff       	jmp    80105b2c <alltraps>
...
8010626d:	6a 44                	push   $0x44
  jmp alltraps
8010626f:	e9 b8 f8 ff ff       	jmp    80105b2c <alltraps>
...
80106276:	6a 45                	push   $0x45
  jmp alltraps
80106278:	e9 af f8 ff ff       	jmp    80105b2c <alltraps>
...
8010627f:	6a 46                	push   $0x46
  jmp alltraps
80106281:	e9 a6 f8 ff ff       	jmp    80105b2c <alltraps>
...
80106288:	6a 47                	push   $0x47
  jmp alltraps
8010628a:	e9 9d f8 ff ff       	jmp    80105b2c <alltraps>
...
80106291:	6a 48                	push   $0x48
  jmp alltraps
80106293:	e9 94 f8 ff ff       	jmp    80105b2c <alltraps>
...
8010629a:	6a 49                	push   $0x49
  jmp alltraps
8010629c:	e9 8b f8 ff ff       	jmp    80105b2c <alltraps>
...
801062a3:	6a 4a                	push   $0x4a
  jmp alltraps
801062a5:	e9 82 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062ac:	6a 4b                	push   $0x4b
  jmp alltraps
801062ae:	e9 79 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062b5:	6a 4c                	push   $0x4c
  jmp alltraps
801062b7:	e9 70 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062be:	6a 4d                	push   $0x4d
  jmp alltraps
801062c0:	e9 67 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062c7:	6a 4e                	push   $0x4e
  jmp alltraps
801062c9:	e9 5e f8 ff ff       	jmp    80105b2c <alltraps>
...
801062d0:	6a 4f                	push   $0x4f
  jmp alltraps
801062d2:	e9 55 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062d9:	6a 50                	push   $0x50
  jmp alltraps
801062db:	e9 4c f8 ff ff       	jmp    80105b2c <alltraps>
...
801062e2:	6a 51                	push   $0x51
  jmp alltraps
801062e4:	e9 43 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062eb:	6a 52                	push   $0x52
  jmp alltraps
801062ed:	e9 3a f8 ff ff       	jmp    80105b2c <alltraps>
...
801062f4:	6a 53                	push   $0x53
  jmp alltraps
801062f6:	e9 31 f8 ff ff       	jmp    80105b2c <alltraps>
...
801062fd:	6a 54                	push   $0x54
  jmp alltraps
801062ff:	e9 28 f8 ff ff       	jmp    80105b2c <alltraps>
...
80106306:	6a 55                	push   $0x55
  jmp alltraps
80106308:	e9 1f f8 ff ff       	jmp    80105b2c <alltraps>
...
8010630f:	6a 56                	push   $0x56
  jmp alltraps
80106311:	e9 16 f8 ff ff       	jmp    80105b2c <alltraps>
...
80106318:	6a 57                	push   $0x57
  jmp alltraps
8010631a:	e9 0d f8 ff ff       	jmp    80105b2c <alltraps>
...
80106321:	6a 58                	push   $0x58
  jmp alltraps
80106323:	e9 04 f8 ff ff       	jmp    80105b2c <alltraps>
...
8010632a:	6a 59                	push   $0x59
  jmp alltraps
8010632c:	e9 fb f7 ff ff       	jmp    80105b2c <alltraps>
...
80106333:	6a 5a                	push   $0x5a
  jmp alltraps
80106335:	e9 f2 f7 ff ff       	jmp    80105b2c <alltraps>
...
8010633c:	6a 5b                	push   $0x5b
  jmp alltraps
8010633e:	e9 e9 f7 ff ff       	jmp    80105b2c <alltraps>
...
80106345:	6a 5c                	push   $0x5c
  jmp alltraps
80106347:	e9 e0 f7 ff ff       	jmp    80105b2c <alltraps>
...
8010634e:	6a 5d                	push   $0x5d
  jmp alltraps
80106350:	e9 d7 f7 ff ff       	jmp    80105b2c <alltraps>
...
80106357:	6a 5e                	push   $0x5e
  jmp alltraps
80106359:	e9 ce f7 ff ff       	jmp    80105b2c <alltraps>
...
80106360:	6a 5f                	push   $0x5f
  jmp alltraps
80106362:	e9 c5 f7 ff ff       	jmp    80105b2c <alltraps>
...
80106369:	6a 60                	push   $0x60
  jmp alltraps
8010636b:	e9 bc f7 ff ff       	jmp    80105b2c <alltraps>
...
80106372:	6a 61                	push   $0x61
  jmp alltraps
80106374:	e9 b3 f7 ff ff       	jmp    80105b2c <alltraps>
...
8010637b:	6a 62                	push   $0x62
  jmp alltraps
8010637d:	e9 aa f7 ff ff       	jmp    80105b2c <alltraps>
...
80106384:	6a 63                	push   $0x63
  jmp alltraps
80106386:	e9 a1 f7 ff ff       	jmp    80105b2c <alltraps>
...
8010638d:	6a 64                	push   $0x64
  jmp alltraps
8010638f:	e9 98 f7 ff ff       	jmp    80105b2c <alltraps>
...
80106396:	6a 65                	push   $0x65
  jmp alltraps
80106398:	e9 8f f7 ff ff       	jmp    80105b2c <alltraps>
...
8010639f:	6a 66                	push   $0x66
  jmp alltraps
801063a1:	e9 86 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063a8:	6a 67                	push   $0x67
  jmp alltraps
801063aa:	e9 7d f7 ff ff       	jmp    80105b2c <alltraps>
...
801063b1:	6a 68                	push   $0x68
  jmp alltraps
801063b3:	e9 74 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063ba:	6a 69                	push   $0x69
  jmp alltraps
801063bc:	e9 6b f7 ff ff       	jmp    80105b2c <alltraps>
...
801063c3:	6a 6a                	push   $0x6a
  jmp alltraps
801063c5:	e9 62 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063cc:	6a 6b                	push   $0x6b
  jmp alltraps
801063ce:	e9 59 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063d5:	6a 6c                	push   $0x6c
  jmp alltraps
801063d7:	e9 50 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063de:	6a 6d                	push   $0x6d
  jmp alltraps
801063e0:	e9 47 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063e7:	6a 6e                	push   $0x6e
  jmp alltraps
801063e9:	e9 3e f7 ff ff       	jmp    80105b2c <alltraps>
...
801063f0:	6a 6f                	push   $0x6f
  jmp alltraps
801063f2:	e9 35 f7 ff ff       	jmp    80105b2c <alltraps>
...
801063f9:	6a 70                	push   $0x70
  jmp alltraps
801063fb:	e9 2c f7 ff ff       	jmp    80105b2c <alltraps>
...
80106402:	6a 71                	push   $0x71
  jmp alltraps
80106404:	e9 23 f7 ff ff       	jmp    80105b2c <alltraps>
...
8010640b:	6a 72                	push   $0x72
  jmp alltraps
8010640d:	e9 1a f7 ff ff       	jmp    80105b2c <alltraps>
...
80106414:	6a 73                	push   $0x73
  jmp alltraps
80106416:	e9 11 f7 ff ff       	jmp    80105b2c <alltraps>
...
8010641d:	6a 74                	push   $0x74
  jmp alltraps
8010641f:	e9 08 f7 ff ff       	jmp    80105b2c <alltraps>
...
80106426:	6a 75                	push   $0x75
  jmp alltraps
80106428:	e9 ff f6 ff ff       	jmp    80105b2c <alltraps>
...
8010642f:	6a 76                	push   $0x76
  jmp alltraps
80106431:	e9 f6 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106438:	6a 77                	push   $0x77
  jmp alltraps
8010643a:	e9 ed f6 ff ff       	jmp    80105b2c <alltraps>
...
80106441:	6a 78                	push   $0x78
  jmp alltraps
80106443:	e9 e4 f6 ff ff       	jmp    80105b2c <alltraps>
...
8010644a:	6a 79                	push   $0x79
  jmp alltraps
8010644c:	e9 db f6 ff ff       	jmp    80105b2c <alltraps>
...
80106453:	6a 7a                	push   $0x7a
  jmp alltraps
80106455:	e9 d2 f6 ff ff       	jmp    80105b2c <alltraps>
...
8010645c:	6a 7b                	push   $0x7b
  jmp alltraps
8010645e:	e9 c9 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106465:	6a 7c                	push   $0x7c
  jmp alltraps
80106467:	e9 c0 f6 ff ff       	jmp    80105b2c <alltraps>
...
8010646e:	6a 7d                	push   $0x7d
  jmp alltraps
80106470:	e9 b7 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106477:	6a 7e                	push   $0x7e
  jmp alltraps
80106479:	e9 ae f6 ff ff       	jmp    80105b2c <alltraps>
...
80106480:	6a 7f                	push   $0x7f
  jmp alltraps
80106482:	e9 a5 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106489:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010648e:	e9 99 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106495:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010649a:	e9 8d f6 ff ff       	jmp    80105b2c <alltraps>
...
801064a1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801064a6:	e9 81 f6 ff ff       	jmp    80105b2c <alltraps>
...
801064ad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801064b2:	e9 75 f6 ff ff       	jmp    80105b2c <alltraps>
...
801064b9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801064be:	e9 69 f6 ff ff       	jmp    80105b2c <alltraps>
...
801064c5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801064ca:	e9 5d f6 ff ff       	jmp    80105b2c <alltraps>
...
801064d1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801064d6:	e9 51 f6 ff ff       	jmp    80105b2c <alltraps>
...
801064dd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801064e2:	e9 45 f6 ff ff       	jmp    80105b2c <alltraps>
...
801064e9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801064ee:	e9 39 f6 ff ff       	jmp    80105b2c <alltraps>
...
801064f5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801064fa:	e9 2d f6 ff ff       	jmp    80105b2c <alltraps>
...
80106501:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106506:	e9 21 f6 ff ff       	jmp    80105b2c <alltraps>
...
8010650d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106512:	e9 15 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106519:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010651e:	e9 09 f6 ff ff       	jmp    80105b2c <alltraps>
...
80106525:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010652a:	e9 fd f5 ff ff       	jmp    80105b2c <alltraps>
...
80106531:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106536:	e9 f1 f5 ff ff       	jmp    80105b2c <alltraps>
...
8010653d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106542:	e9 e5 f5 ff ff       	jmp    80105b2c <alltraps>
...
80106549:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010654e:	e9 d9 f5 ff ff       	jmp    80105b2c <alltraps>
...
80106555:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010655a:	e9 cd f5 ff ff       	jmp    80105b2c <alltraps>
...
80106561:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106566:	e9 c1 f5 ff ff       	jmp    80105b2c <alltraps>
...
8010656d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106572:	e9 b5 f5 ff ff       	jmp    80105b2c <alltraps>
...
80106579:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010657e:	e9 a9 f5 ff ff       	jmp    80105b2c <alltraps>
...
80106585:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010658a:	e9 9d f5 ff ff       	jmp    80105b2c <alltraps>
...
80106591:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106596:	e9 91 f5 ff ff       	jmp    80105b2c <alltraps>
...
8010659d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801065a2:	e9 85 f5 ff ff       	jmp    80105b2c <alltraps>
...
801065a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801065ae:	e9 79 f5 ff ff       	jmp    80105b2c <alltraps>
...
801065b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801065ba:	e9 6d f5 ff ff       	jmp    80105b2c <alltraps>
...
801065c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801065c6:	e9 61 f5 ff ff       	jmp    80105b2c <alltraps>
...
801065cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801065d2:	e9 55 f5 ff ff       	jmp    80105b2c <alltraps>
...
801065d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801065de:	e9 49 f5 ff ff       	jmp    80105b2c <alltraps>
...
801065e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801065ea:	e9 3d f5 ff ff       	jmp    80105b2c <alltraps>
...
801065f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801065f6:	e9 31 f5 ff ff       	jmp    80105b2c <alltraps>
...
801065fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106602:	e9 25 f5 ff ff       	jmp    80105b2c <alltraps>
...
80106609:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010660e:	e9 19 f5 ff ff       	jmp    80105b2c <alltraps>
...
80106615:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010661a:	e9 0d f5 ff ff       	jmp    80105b2c <alltraps>
...
80106621:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106626:	e9 01 f5 ff ff       	jmp    80105b2c <alltraps>
...
8010662d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106632:	e9 f5 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106639:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010663e:	e9 e9 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106645:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010664a:	e9 dd f4 ff ff       	jmp    80105b2c <alltraps>
...
80106651:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106656:	e9 d1 f4 ff ff       	jmp    80105b2c <alltraps>
...
8010665d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106662:	e9 c5 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106669:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010666e:	e9 b9 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106675:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010667a:	e9 ad f4 ff ff       	jmp    80105b2c <alltraps>
...
80106681:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106686:	e9 a1 f4 ff ff       	jmp    80105b2c <alltraps>
...
8010668d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106692:	e9 95 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106699:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010669e:	e9 89 f4 ff ff       	jmp    80105b2c <alltraps>
...
801066a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801066aa:	e9 7d f4 ff ff       	jmp    80105b2c <alltraps>
...
801066b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801066b6:	e9 71 f4 ff ff       	jmp    80105b2c <alltraps>
...
801066bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801066c2:	e9 65 f4 ff ff       	jmp    80105b2c <alltraps>
...
801066c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801066ce:	e9 59 f4 ff ff       	jmp    80105b2c <alltraps>
...
801066d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801066da:	e9 4d f4 ff ff       	jmp    80105b2c <alltraps>
...
801066e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801066e6:	e9 41 f4 ff ff       	jmp    80105b2c <alltraps>
...
801066ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801066f2:	e9 35 f4 ff ff       	jmp    80105b2c <alltraps>
...
801066f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801066fe:	e9 29 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106705:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010670a:	e9 1d f4 ff ff       	jmp    80105b2c <alltraps>
...
80106711:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106716:	e9 11 f4 ff ff       	jmp    80105b2c <alltraps>
...
8010671d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106722:	e9 05 f4 ff ff       	jmp    80105b2c <alltraps>
...
80106729:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010672e:	e9 f9 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106735:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010673a:	e9 ed f3 ff ff       	jmp    80105b2c <alltraps>
...
80106741:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106746:	e9 e1 f3 ff ff       	jmp    80105b2c <alltraps>
...
8010674d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106752:	e9 d5 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106759:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010675e:	e9 c9 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106765:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010676a:	e9 bd f3 ff ff       	jmp    80105b2c <alltraps>
...
80106771:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106776:	e9 b1 f3 ff ff       	jmp    80105b2c <alltraps>
...
8010677d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106782:	e9 a5 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106789:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010678e:	e9 99 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106795:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010679a:	e9 8d f3 ff ff       	jmp    80105b2c <alltraps>
...
801067a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801067a6:	e9 81 f3 ff ff       	jmp    80105b2c <alltraps>
...
801067ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801067b2:	e9 75 f3 ff ff       	jmp    80105b2c <alltraps>
...
801067b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801067be:	e9 69 f3 ff ff       	jmp    80105b2c <alltraps>
...
801067c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801067ca:	e9 5d f3 ff ff       	jmp    80105b2c <alltraps>
...
801067d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801067d6:	e9 51 f3 ff ff       	jmp    80105b2c <alltraps>
...
801067dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801067e2:	e9 45 f3 ff ff       	jmp    80105b2c <alltraps>
...
801067e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801067ee:	e9 39 f3 ff ff       	jmp    80105b2c <alltraps>
...
801067f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801067fa:	e9 2d f3 ff ff       	jmp    80105b2c <alltraps>
...
80106801:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106806:	e9 21 f3 ff ff       	jmp    80105b2c <alltraps>
...
8010680d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106812:	e9 15 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106819:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010681e:	e9 09 f3 ff ff       	jmp    80105b2c <alltraps>
...
80106825:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010682a:	e9 fd f2 ff ff       	jmp    80105b2c <alltraps>
...
80106831:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106836:	e9 f1 f2 ff ff       	jmp    80105b2c <alltraps>
...
8010683d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106842:	e9 e5 f2 ff ff       	jmp    80105b2c <alltraps>
...
80106849:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010684e:	e9 d9 f2 ff ff       	jmp    80105b2c <alltraps>
...
80106855:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010685a:	e9 cd f2 ff ff       	jmp    80105b2c <alltraps>
...
80106861:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106866:	e9 c1 f2 ff ff       	jmp    80105b2c <alltraps>
...
8010686d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106872:	e9 b5 f2 ff ff       	jmp    80105b2c <alltraps>
...
80106879:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010687e:	e9 a9 f2 ff ff       	jmp    80105b2c <alltraps>
...
80106885:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010688a:	e9 9d f2 ff ff       	jmp    80105b2c <alltraps>
...
80106891:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106896:	e9 91 f2 ff ff       	jmp    80105b2c <alltraps>
...
8010689d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801068a2:	e9 85 f2 ff ff       	jmp    80105b2c <alltraps>
...
801068a9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801068ae:	e9 79 f2 ff ff       	jmp    80105b2c <alltraps>
...
801068b5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801068ba:	e9 6d f2 ff ff       	jmp    80105b2c <alltraps>
...
801068c1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801068c6:	e9 61 f2 ff ff       	jmp    80105b2c <alltraps>
...
801068cd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801068d2:	e9 55 f2 ff ff       	jmp    80105b2c <alltraps>
...
801068d9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801068de:	e9 49 f2 ff ff       	jmp    80105b2c <alltraps>
...
801068e5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801068ea:	e9 3d f2 ff ff       	jmp    80105b2c <alltraps>
...
801068f1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801068f6:	e9 31 f2 ff ff       	jmp    80105b2c <alltraps>
...
801068fd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106902:	e9 25 f2 ff ff       	jmp    80105b2c <alltraps>
...
80106909:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010690e:	e9 19 f2 ff ff       	jmp    80105b2c <alltraps>
...
80106915:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010691a:	e9 0d f2 ff ff       	jmp    80105b2c <alltraps>
...
80106921:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106926:	e9 01 f2 ff ff       	jmp    80105b2c <alltraps>
...
8010692d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106932:	e9 f5 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106939:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010693e:	e9 e9 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106945:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010694a:	e9 dd f1 ff ff       	jmp    80105b2c <alltraps>
...
80106951:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106956:	e9 d1 f1 ff ff       	jmp    80105b2c <alltraps>
...
8010695d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106962:	e9 c5 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106969:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010696e:	e9 b9 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106975:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010697a:	e9 ad f1 ff ff       	jmp    80105b2c <alltraps>
...
80106981:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106986:	e9 a1 f1 ff ff       	jmp    80105b2c <alltraps>
...
8010698d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106992:	e9 95 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106999:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010699e:	e9 89 f1 ff ff       	jmp    80105b2c <alltraps>
...
801069a5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801069aa:	e9 7d f1 ff ff       	jmp    80105b2c <alltraps>
...
801069b1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801069b6:	e9 71 f1 ff ff       	jmp    80105b2c <alltraps>
...
801069bd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801069c2:	e9 65 f1 ff ff       	jmp    80105b2c <alltraps>
...
801069c9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801069ce:	e9 59 f1 ff ff       	jmp    80105b2c <alltraps>
...
801069d5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801069da:	e9 4d f1 ff ff       	jmp    80105b2c <alltraps>
...
801069e1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801069e6:	e9 41 f1 ff ff       	jmp    80105b2c <alltraps>
...
801069ed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801069f2:	e9 35 f1 ff ff       	jmp    80105b2c <alltraps>
...
801069f9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801069fe:	e9 29 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106a05:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a0a:	e9 1d f1 ff ff       	jmp    80105b2c <alltraps>
...
80106a11:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106a16:	e9 11 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106a1d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106a22:	e9 05 f1 ff ff       	jmp    80105b2c <alltraps>
...
80106a29:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106a2e:	e9 f9 f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a35:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106a3a:	e9 ed f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a41:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106a46:	e9 e1 f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a4d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106a52:	e9 d5 f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a59:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106a5e:	e9 c9 f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a65:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106a6a:	e9 bd f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a71:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a76:	e9 b1 f0 ff ff       	jmp    80105b2c <alltraps>
...
80106a7d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a82:	e9 a5 f0 ff ff       	jmp    80105b2c <alltraps>
...
80106bd5:	e8 d6 dc ff ff       	call   801048b0 <memset>
...
80106c1d:	68 b4 7d 10 80       	push   $0x80107db4
...
80106c33:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106c36:	e8 25 cd ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106cc0:	a1 c4 5d 11 80       	mov    0x80115dc4,%eax
...
80106cf4:	0f 84 c2 00 00 00    	je     80106dbc <switchuvm+0xec>
  pushcli();
80106cfa:	e8 a1 d9 ff ff       	call   801046a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106cff:	e8 fc cb ff ff       	call   80103900 <mycpu>
80106d04:	89 c3                	mov    %eax,%ebx
80106d06:	e8 f5 cb ff ff       	call   80103900 <mycpu>
80106d0b:	89 c7                	mov    %eax,%edi
80106d0d:	e8 ee cb ff ff       	call   80103900 <mycpu>
80106d12:	83 c7 08             	add    $0x8,%edi
80106d15:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d18:	e8 e3 cb ff ff       	call   80103900 <mycpu>
...
80106d66:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d6d:	e8 8e cb ff ff       	call   80103900 <mycpu>
...
80106d84:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d87:	e8 74 cb ff ff       	call   80103900 <mycpu>
...
80106e0f:	e8 9c da ff ff       	call   801048b0 <memset>
...
80106e42:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e43:	e9 08 db ff ff       	jmp    80104950 <memmove>
    panic("inituvm: more than a page");
80106e48:	83 ec 0c             	sub    $0xc,%esp
80106e4b:	68 f9 7d 10 80       	push   $0x80107df9
...
80106eb0:	68 13 7e 10 80       	push   $0x80107e13
...
80106f38:	68 b4 7e 10 80       	push   $0x80107eb4
...
80106f9b:	e8 10 d9 ff ff       	call   801048b0 <memset>
...
80106fd9:	68 31 7e 10 80       	push   $0x80107e31
...
8010703b:	68 49 7e 10 80       	push   $0x80107e49
...
8010711c:	68 65 7e 10 80       	push   $0x80107e65
...
80107150:	e8 5b d7 ff ff       	call   801048b0 <memset>
...
801071bb:	a3 c4 5d 11 80       	mov    %eax,0x80115dc4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801071ec:	68 76 7e 10 80       	push   $0x80107e76
...
80107262:	68 80 7e 10 80       	push   $0x80107e80
...
801072c0:	e8 8b d6 ff ff       	call   80104950 <memmove>
...
80107337:	68 9a 7e 10 80       	push   $0x80107e9a
...
801073f0:	e8 5b d5 ff ff       	call   80104950 <memmove>
    len -= n;
    buf += n;
