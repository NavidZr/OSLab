 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 d8 07 00 00 	jmp    *0x7d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba cf 07 00 00       	mov    $0x7cf,%edx
        while(*s != 0){
 ...
 621:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 dc 0a 00 00    	mov    %edx,0xadc
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 dc 0a 00 00    	mov    %edx,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 792:	00 00 00 
    if(p->s.size >= nunits){
