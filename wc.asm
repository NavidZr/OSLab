 ...
 4fc:	89 d1                	mov    %edx,%ecx
{
 ...
 56e:	56                   	push   %esi
 56f:	57                   	push   %edi
 570:	e8 7e fe ff ff       	call   3f3 <write>
  while(--i >= 0)
 ...
 5a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e5:	57                   	push   %edi
 5e6:	56                   	push   %esi
 5e7:	e8 07 fe ff ff       	call   3f3 <write>
 ...
 63e:	e8 b0 fd ff ff       	call   3f3 <write>
        putc(fd, c);
 ...
 6bb:	57                   	push   %edi
 6bc:	56                   	push   %esi
 6bd:	e8 31 fd ff ff       	call   3f3 <write>
        while(*s != 0){
 ...
 6fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6ff:	e8 ef fc ff ff       	call   3f3 <write>
        ap++;
 ...
 727:	90                   	nop
          s = "(null)";
 728:	ba ff 08 00 00       	mov    $0x8ff,%edx
        while(*s != 0){
 ...
 741:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 788:	5e                   	pop    %esi
 789:	5f                   	pop    %edi
 78a:	5d                   	pop    %ebp
 ...
 7b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7bc:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7dc:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 81f:	73 4f                	jae    870 <malloc+0xa0>
    ...
    if(p == freep)
 821:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 833:	e8 23 fc ff ff       	call   45b <sbrk>
  if(p == (char*)-1)
 ...
 84a:	e8 f1 fe ff ff       	call   740 <free>
  return freep;
 84f:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 897:	0e 00 00 
    base.s.size = 0;
 89a:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 8a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8ab:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 8b2:	00 00 00 
    if(p->s.size >= nunits){
