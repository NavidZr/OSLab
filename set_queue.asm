...
_set_queue:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  2f:	53                   	push   %ebx
  30:	50                   	push   %eax
  31:	e8 2d 03 00 00       	call   363 <set_queue>
...
free(void *ap)
{
 ...
 605:	a1 50 0a 00 00       	mov    0xa50,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 50 0a 00 00       	mov    0xa50,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 54 0a 00 00       	mov    $0xa54,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 782:	00 00 00 
    if(p->s.size >= nunits){
