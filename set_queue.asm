...
main(int argc, char *argv[])
{
  ...
  2b:	53                   	push   %ebx
  2c:	50                   	push   %eax
  2d:	e8 21 03 00 00       	call   353 <set_queue>
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 42e:	56                   	push   %esi
 42f:	57                   	push   %edi
 430:	e8 7e fe ff ff       	call   2b3 <write>
  while(--i >= 0)
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 07 fe ff ff       	call   2b3 <write>
 ...
 4fe:	e8 b0 fd ff ff       	call   2b3 <write>
        putc(fd, c);
 ...
 50f:	57                   	push   %edi
 510:	56                   	push   %esi
 511:	e8 9d fd ff ff       	call   2b3 <write>
        putc(fd, c);
 ...
 57b:	57                   	push   %edi
 57c:	56                   	push   %esi
 57d:	e8 31 fd ff ff       	call   2b3 <write>
        while(*s != 0){
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 ef fc ff ff       	call   2b3 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6f3:	e8 23 fc ff ff       	call   31b <sbrk>
  if(p == (char*)-1)
